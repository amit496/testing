                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-8">
                                <p>
                                    <strong><?php echo app('translator')->get('app.reason'); ?>:</strong>
                                ...
                                <?php if($order->cancellation->description): ?>
                                    <p>
                                        <strong><?php echo app('translator')->get('app.detail'); ?>:</strong>
                                ...
                                <?php if($order->cancellation->isNew() || $order->cancellation->isPending()): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/order/show.blade.php ENDPATH**/ ?>