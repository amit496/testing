...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', $customer)): ?>
  <?php if($customer->primaryAddress): ?>
    <a href="<?php echo e(route('admin.admin.customer.addresses', $customer->id), false); ?>"><i data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.show_addresses'), false); ?>" class="fa fa-address-card-o"></i></a>&nbsp;
  <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/partials/actions/customer/options.blade.php ENDPATH**/ ?>