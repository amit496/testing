  ...
  <div class="box">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Merchant::class)): ?>
    ...
    <div class="box-body">
      <table class="table table-hover table-2nd-no-sort">
        <thead>
          <tr>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDelete', \App\Models\Shop::class)): ?>
              <th class="massActionWrapper">
                ...
                <div class="btn-group ">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li>
                      <a href="javascript:void(0)" data-link="<?php echo e(route('admin.vendor.shop.massTrash'), false); ?>" class="massAction " data-doafter="reload"><i class="fa fa-trash"></i> <?php echo e(trans('app.trash'), false); ?></a>
                    </li>
                    <li>
                      <a href="javascript:void(0)" data-link="<?php echo e(route('admin.vendor.shop.massDestroy'), false); ?>" class="massAction " data-doafter="reload"><i class="fa fa-times"></i> <?php echo e(trans('app.delete_permanently'), false); ?></a>
                    </li>
                  </ul>
                </div>
              </th>
            ...
            <?php if(is_incevio_package_loaded('dynamicCommission')): ?>
              <th><?php echo e(trans('dynamicCommission::lang.periodic_sold_amount'), false); ?></th>
            <?php endif; ?>
        ...
        <tbody id="massSelectArea">
          <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="<?php echo e(!$shop->active ? 'inactive' : '', false); ?>">
              ...
              <?php endif; ?>
              <td>
                <img src="<?php echo e(get_storage_file_url(optional($shop->logoImage)->path, 'tiny'), false); ?>" class="img-circle img-sm" alt="<?php echo e(trans('app.logo'), false); ?>">
              </td>
              <td>
              ...
              <?php if(is_incevio_package_loaded('dynamicCommission')): ?>
                <td><?php echo e(get_formated_currency($shop->periodic_sold_amount), false); ?></td>
              <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/shop/index.blade.php ENDPATH**/ ?>