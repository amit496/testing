    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-md-4 nopadding-left">
          <div class="form-group">
            ...
            <?php echo Form::select('status', $statuses, isset($order) && $order->dispute ? \App\Models\Refund::STATUS_APPROVED : \App\Models\Refund::STATUS_NEW, ['class' => 'form-control select2-normal', 'placeholder' => trans('app.placeholder.status'), 'required']); ?>
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <?php echo Form::number('amount', isset($order) && $order->dispute && $order->dispute->refund_amount ? get_formated_decimal($order->dispute->refund_amount, true, config('system_settings.decimals', 2)) : null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('app.placeholder.refund_amount'), 'required']); ?>
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/refund/_initiate.blade.php ENDPATH**/ ?>