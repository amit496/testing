                ...
                <?php if(
                    ...
                    <li
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if(Gate::allows('index', \App\Models\Customer::class)): ?>
                                <li
                    ...
                    <li class="treeview <?php echo e(Request::is('admin/support*') ? 'active' : '', false); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php endif; ?>
                                ...
                                <li class="<?php echo e(Request::is('admin/show/contactus') ? 'active' : '', false); ?>">
                                    <a href="<?php echo e(url('admin/show/contactus'), false); ?>">
                                        <i class="fa fa-angle-double-right"></i> <?php echo e(trans('nav.contacts'), false); ?>
...
</aside><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/sidebar.blade.php ENDPATH**/ ?>