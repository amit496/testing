  ...
  <div class="box">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\CategorySubGroup::class)): ?>
    ...
    <div class="box-body">
      <table class="table table-hover table-2nd-no-sort">
        <thead>
          <tr>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDelete', \App\Models\CategorySubGroup::class)): ?>
        ...
        <tbody id="massSelectArea">
          <?php $__currentLoopData = $categorySubGrps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorySubGrp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <?php endif; ?>
              <td>
                <img src="<?php echo e(get_storage_file_url(optional($categorySubGrp->coverImage)->path, 'cover_thumb'), false); ?>" class="img-sm" alt="<?php echo e(trans('app.cover_image'), false); ?>">
              </td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/category/categorySubGroup.blade.php ENDPATH**/ ?>