          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              ...
              <?php if($can_update): ?>
                ...
                <div class="form-group">
                  <label for="exampleInputFile" class="with-help col-sm-3 control-label"> <?php echo e(trans('app.form.trust_badge'), false); ?></label>

                  <div class="col-md-6 nopadding">
                    <input id="uploadFile2" placeholder="<?php echo e(trans('app.placeholder.trust_badge'), false); ?>" class="form-control" disabled="disabled" style="height: 28px;" />
                  </div>
            ...
            <div class="col-sm-3 nopadding-left">
              ...
              <div class="text-center">
                ...
                <?php if($system->primaryAddress): ?>
                  ...
                  <a href="javascript:void(0)" data-link="<?php echo e(route('address.edit', $system->primaryAddress->id), false); ?>" class="btn btn-default ajax-modal-btn">
                    <i class="fa fa-map-marker"></i> <?php echo e(trans('app.update_address'), false); ?>

                  </a>
                <?php else: ?>
                  <a href="javascript:void(0)" data-link="<?php echo e(route('address.create', ['system', $system->id]), false); ?>" class="btn btn-default ajax-modal-btn">
                    <i class="fa fa-plus-square-o"></i> <?php echo e(trans('app.add_address'), false); ?>
              ...
              <?php if($trust_badge = get_trust_badge_url()): ?>
                <div class="form-group text-center">
                  <label class="with-help control-label"> <?php echo e(trans('app.trust_badge'), false); ?>: </label>
                  <img src="<?php echo e($trust_badge, false); ?>" class="brand-logo" style="max-width: 90%" alt="<?php echo e(trans('app.trust_badge'), false); ?>">
                </div>
              <?php endif; ?>
            </div>
            <?php echo Form::close(); ?>
        ...
        <div class="tab-pane" id="envioronment_config_tab">
          ...
          <?php if(Auth::guard('web')->user()->isSuperAdmin()): ?>
            <div class="row">
              <div class="col-sm-4 text-center">
                <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.modifyEnvFile'), false); ?>" class="ajax-modal-btn btn btn-default btn-lg ">
                  <?php echo e(trans('app.modify_environment_file'), false); ?>
                ...
                <p class="text-danger">
                  <i class="fa fa-exclamation-triangle"></i> <?php echo trans('messages.modify_environment_file'); ?>

                </p>
              </div><!-- /.col-sm-4 -->

              <div class="col-sm-4 text-center">
                <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.importDemoContents'), false); ?>" class="ajax-modal-btn btn btn-default btn-lg ">
                  <?php echo e(trans('app.import_demo_contents'), false); ?>

                </a>

                <div class="spacer10"></div>
                <p class="text-danger">
                  <i class="fa fa-exclamation-triangle"></i> <?php echo trans('messages.import_demo_contents'); ?>
              ...
              <div class="col-sm-4 text-center">
                <?php if(config('app.demo') !== true): ?>
                  <a href="<?php echo e(route('admin.setting.system.backup'), false); ?>" class="btn btn-default btn-lg confirm">
                    <?php echo e(trans('app.take_a_backup'), false); ?>
                ...
                <p class="text-info">
                  <i class="fa fa-info-circle"></i> <?php echo trans('messages.take_a_backup'); ?>
            ...
            <div class="row">
              <?php if (! (config('app.demo') == true)): ?>
                ...
                <div class="col-sm-4 text-center">
                  <a href="<?php echo e(route('admin.incevio.clear'), false); ?>" class="btn btn-default btn-lg confirm">
                    <?php echo e(trans('app.clear_cache'), false); ?>
                  ...
                  <p class="text-danger">
                    <i class="fa fa-info-circle"></i> <?php echo trans('help.help_clear_cache'); ?>

                  </p>
                </div><!-- /.col-sm-4 -->

                <div class="col-sm-4 text-justify">
                  <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.license.uninstall'), false); ?>" class="ajax-modal-btn btn btn-danger btn-lg">
                    <?php echo e(trans('app.uninstall_app_license'), false); ?>
                  ...
                  <p class="text-danger">
                    ...
                    <?php echo trans('messages.uninstall_app_license'); ?>

                  </p>
                </div><!-- /.col-sm-4 -->

                <div class="col-sm-4 text-justify">
                  <a href="<?php echo e(route('admin.setting.license.update'), false); ?>" class="btn btn-default btn-lg confirm">
                    <?php echo e(trans('app.update_app_license'), false); ?>
                  ...
                  <p class="text-info">
                    ...
                    <?php echo trans('messages.update_app_license'); ?>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="spacer10"></div>
              <div class="form-group">
                <label for=""><?php echo e(trans('app.zcart_application_key'), false); ?></label>
                <div class="input-group">
                  <input type="password" id="key" class="form-control" value="<?php echo e(env('ZCART_API_KEY') ?: env('ZCART_API_KEY'), false); ?>" readonly>
                  <span class="input-group-addon fa fa-clipboard" onclick="copy_to_clipboard(this)" data-key="copy-key"> <?php echo e(trans('app.copy'), false); ?></span>
                </div>
              </div>
              <div class="form-group">
                <label for=""><?php echo e(trans('app.zcart_application_secret'), false); ?></label>
                <div class="input-group">
                  <input type="password" id="secret" class="form-control" value="<?php echo e(env('ZCART_ENCRYPTION_KEY') ?? env('ZCART_ENCRYPTION_KEY'), false); ?>" readonly>
                  <span class="input-group-addon fa fa-clipboard" onclick="copy_to_clipboard(this)" data-key="copy-secret"> <?php echo e(trans('app.copy'), false); ?></span>
                </div>
              </div>
              <div class="form-group">
                <label for=""><?php echo e(trans('app.zcart_application_iv'), false); ?></label>
                <div class="input-group">
                  <input type="password" id="iv" class="form-control" value="<?php echo e(env('ZCART_ENCRYPTION_IV') ?? env('ZCART_ENCRYPTION_IV'), false); ?>" readonly>
                  <span class="input-group-addon fa fa-clipboard" onclick="copy_to_clipboard(this)" data-key="copy-iv"> <?php echo e(trans('app.copy'), false); ?></span>
                </div>
              </div>
              <input type="button" id="toggleBtn" value="<?php echo e(trans('app.show'), false); ?>" onclick="show_application_key()" class="btn btn-default btn-lg">

              <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.key.confirm'), false); ?>" class="ajax-modal-btn btn btn-danger btn-lg">
                <?php echo e(trans('app.regenerate_key'), false); ?>
  ...
  <script>
    const show_application_key = () => {
      ...
      if (key.type == "password" && secret.type == "password" && iv.type == "password") {
        ...
        secret.type = "text";
        iv.type = "text";
        toggleBtn.value = "<?php echo e(trans('app.hide'), false); ?>";
      } else {
        key.type = "password";
        secret.type = "password";
        iv.type = "password";
        toggleBtn.value = "<?php echo e(trans('app.show'), false); ?>";
      }
    }
    const copy_to_clipboard = (object) => {
      ...
      switch (id) {
        case 'copy-key':
          data = '<?php echo e(env('ZCART_API_KEY') ?: env('ZCART_API_KEY'), false); ?>';
          $(object).html(' <?php echo e(trans('app.copied'), false); ?>')
          break;
        case 'copy-secret':
          $(object).html(' <?php echo e(trans('app.copied'), false); ?>')
          data = '<?php echo e(env('ZCART_ENCRYPTION_KEY') ?: env('ZCART_ENCRYPTION_KEY'), false); ?>';
          break;
        case 'copy-iv':
          $(object).html(' <?php echo e(trans('app.copied'), false); ?>')
          data = '<?php echo e(env('ZCART_ENCRYPTION_IV') ?: env('ZCART_ENCRYPTION_IV'), false); ?>';
          break;
        default:
          break;
      }
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/system/general.blade.php ENDPATH**/ ?>