<?php $__env->startSection('content'); ?>
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Inventory::class)): ?>
          ...
          <table class="table table-hover" id="active_inventory">
            <thead>
              <tr>
                ...
                <th><?php echo e(trans('app.sale_price'), false); ?> <small>( <?php echo e(trans('app.excl_tax'), false); ?> )</small> </th>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/inventory/index.blade.php ENDPATH**/ ?>