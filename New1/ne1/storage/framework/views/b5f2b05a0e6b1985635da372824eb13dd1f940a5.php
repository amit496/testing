      ...
      <div class="container ">
         ...
         <section class="stf_start_screen p-2" style="display: <?php if(isset($show_quesiton_answer_fisrt_screen) ) { echo $show_quesiton_answer_fisrt_screen;}else { echo 'none'; } ?>">
            ...
            $start_screen_subheading_text_2 = "<p>This questionnaire is a once-off to ensure a comprehensive and personalised service with your stylist. It will take roughly 10 min to complete.</p>
                                    <p> At the end of the questionnaire choose the stylist you'd like to work with, and arrange a time with them for a video call.</p>";
...
Ready to finish and receive your first reveal? Continue editing";
        ...
        <form action="/storeAnswers" method="post">
         ...
         $sections_screen_arr[2] = array('title' => 'Personal Style', 'title_1' => 'Let us know a bit more about your current style',  'title_2' => '', 'description' => $login_cutomer_obj->name.', tell us a bit about your current personal style. What you\'re drawn too, what you\'d potentially like to change or get advice on and how we can help your personal brand and image develop.','img_desktop' => 'images/stylist/questions/section/1_personal_style.webp','womens_screen_image' => 'images/stylist/questions/section/Dappr_animal.jpg' , 'img_mobile' => 'images/stylist/questions/section/1_personal_style.webp','section_id' => 2,'progress_bar_start' => 37,'progress_bar_end' => 59, 'button_text'=>'SAVE & CONTINUE LATER');
...
<?php echo $__env->make('theme::layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/stylist_form/customer_question_answer.blade.php ENDPATH**/ ?>