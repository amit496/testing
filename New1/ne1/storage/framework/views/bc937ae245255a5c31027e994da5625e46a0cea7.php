...
<section>
  <div class="container">
              ...
              <ul class="shopping-cart-summary ">
                  ...
                  ?>
                    ...
                    <li id="discount-section-li<?php echo e($cart->id, false); ?>disc">
                      ...
                      <span><?php echo e(get_currency_prefix(), false); ?>
                        ...
                        <span id="summary-discount<?php echo e($cart->id, false); ?>disc"><?php echo e($cart->coupon ?
                    ...
                    <li>
                        <span>
                          <a class="dynamic-shipping-rates" data-toggle="popover" data-cart="<?php echo e($cart->id, false); ?>"data-options="<?php echo e($shipping_options[$cart->id], false); ?>"id="shipping-options<?php echo e($cart->id, false); ?>" title="<?php echo e(trans('theme.shipping'), false); ?>"><u><?php echo e(trans('theme.shipping'), false); ?></u></a>
                    ...
                    <li>
                      ...
                      <span class="lead"><?php echo e(get_currency_prefix(), false); ?>
                        ...
                        <span id="summary-grand-total<?php echo e($cart->id, false); ?>12"><?php echo e(number_format($order_total, 2, '.', ''), false); ?></span><?php echo e(get_currency_suffix(), false); ?>
                ...
                <div class="text-center space20">
                    <a class="btn btn-black flat"
                        href="<?php echo e(route('cart.index'), false); ?>"><?php echo e(trans('theme.button.update_cart'), false); ?></a>
                    <a class="btn btn-black flat"
                        href="<?php echo e(url('/'), false); ?>"><?php echo e(trans('theme.button.continue_shopping'), false); ?></a>
                </div>
            </div> <!-- /.col-md-3 -->
    ...
    elseif ($cart->ship_to == null && $address->address_type === 'Shipping') {
                            ...
                            <div
                                class="col-sm-12 col-md-6 nopadding-<?php echo e($loop->iteration % 2 == 1 ? 'right' : 'left', false); ?>">
                                <div class="address-list-item <?php echo e($ship_to_this_address == true ? 'selected' : '', false); ?>">
                                    ...
                                    <input type="radio" class="ship-to-address" name="ship_to"
                                        value="<?php echo e($address->id, false); ?>"
                                        <?php echo e($ship_to_this_address == true ? 'checked' : '', false); ?>

                                        data-country="<?php echo e($address->country_id, false); ?>"
                                        data-state="<?php echo e($address->state_id, false); ?>" required>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12 space20">
                        <a href="<?php echo e(route('my.address.create'), false); ?>"
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::textarea('buyer_note', null, [
