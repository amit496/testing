...
<?php $__env->startSection('content'); ?>
      ...
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">
            ...
            <a href="<?php echo e(url('/admin/order/order'), false); ?>" class="pull-right small" data-toggle="tooltip" data-placement="left" title="<?php echo e(trans('app.detail'), false); ?>">
              <i class="icon ion-md-send"></i>
            </a>
          </span>
  ...
  <div class="row">
    <div class="col-md-8 col-sm-7 col-xs-12">
      ...
      <?php endif; ?>
        <div class="row box" style="margin-left: 0px;">
          <div class="col-lg-12 p-1">
            <h5 class="text-center text-bold">TODAY ORDERS LIST</h5>
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody>
                <?php $__currentLoopData = $order_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $order_data_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><a href="<?php echo e(route('admin.order.order.show', $order_data_val->id), false); ?>">
                      <?php echo e($order_data_val->order_number, false); ?>

                    </a></td>
                    <td><?php echo e($order_data_val->customer->getName(), false); ?></td>
                    <td><?php echo e(get_formated_currency($order_data_val->grand_total, 2), false); ?></td>
                    <td><?php echo $order_data_val->paymentStatusName(); ?></td>

                    <td><?php echo e($order_data_val->created_at->format('d/m/Y'), false); ?></td>
                  </tr>
        ...
        <div class="row box" style="margin-left: 0px;">
          <div class="col-lg-12 p-1">
            <h5 class="text-center text-bold bg-dark">TODAY CANCELLATION LIST</h5>
            <table class="table">
              <thead>
                <tr>
                  <th><?php echo e(trans('app.order_number'), false); ?></th>
              ...
              <tbody>
                <?php $__currentLoopData = $cancellations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cancellation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><?php echo e($cancellation->customer->getName(), false); ?></td>
                    ...
                    <td><?php echo e($cancellation->created_at->format('d/m/Y'), false); ?></td>
                  </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="visitors_tab">
              <?php if(\App\Models\SystemConfig::isGgoogleAnalyticEnabled() && !\App\Models\SystemConfig::isGgoogleAnalyticConfigured()): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/dashboard/platform.blade.php ENDPATH**/ ?>