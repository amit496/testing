...
<div class="form-group">
  ...
  <?php if(isset($customer) && Storage::exists(optional($customer->image)->path)): ?>
  <label>
    <img src="<?php echo e(get_storage_file_url(optional($customer->image)->path, 'small'), false); ?>" width="" alt="<?php echo e(trans('app.avatar'), false); ?>">
...
<p class="help-block">* <?php echo e(trans('app.form.required_fields'), false); ?></p><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/customer/_form.blade.php ENDPATH**/ ?>