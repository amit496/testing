      ...
      <div class="tab-content">
        <div class="tab-pane active" id="basic_settings_tab">
          <div class="row">
            ...
            <div class="col-sm-6">
              <fieldset>
                <legend><?php echo e(trans('app.config_subscription_section'), false); ?>

                  <small><?php echo e(is_subscription_enabled() ? '' : '(' . trans('app.disabled') . ')', false); ?></small>
                </legend>
                  ...
                  <div class="col-sm-5 nopadding-left">
                    <?php if($can_update): ?>
                      <div class="input-group">
                        <?php echo Form::number('trial_days', $system->trial_days, ['class' => 'form-control', 'max' => '730', 'placeholder' => trans('app.placeholder.trial_days'), is_subscription_enabled() ? '' : 'disabled']); ?>
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'required_card_upfront'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->required_card_upfront ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->required_card_upfront ? 'true' : 'false', false); ?>" autocomplete="off" <?php echo e(is_subscription_enabled() ? '' : 'disabled', false); ?>>
              ...
              <fieldset>
                <legend><?php echo e(trans('app.vendors'), false); ?> </legend>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'vendor_needs_approval'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->vendor_needs_approval ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->vendor_needs_approval ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'can_use_own_catalog_only'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->can_use_own_catalog_only ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->can_use_own_catalog_only ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  <div class="col-sm-7 text-right">
                    <div class="form-group">
                      <?php echo Form::label('show_merchant_info_as_vendor', trans('app.show_merchant_info_as_vendor') . ':', ['class' => 'with-help control-label']); ?>

                      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="left" title="<?php echo e(trans('help.show_merchant_info_as_vendor'), false); ?>"></i>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'show_merchant_info_as_vendor'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->show_merchant_info_as_vendor ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->show_merchant_info_as_vendor ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                      <span><?php echo e($system->show_merchant_info_as_vendor ? trans('app.on') : trans('app.off'), false); ?></span>
                    <?php endif; ?>
                  </div>
                </div> <!-- /.row -->
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'vendor_can_view_customer_info'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->vendor_can_view_customer_info ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->vendor_can_view_customer_info ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'enable_chat'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->enable_chat ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->enable_chat ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="form-group">
                  <?php echo Form::label('vendor_order_cancellation_fee', trans('app.vendor_order_cancellation_fee') . ':', ['class' => 'with-help col-sm-6 control-label']); ?>

                  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="left" title="<?php echo e(trans('help.config_vendor_order_cancellation_fee'), false); ?>"></i>
                  <div class="col-sm-5 nopadding-left">
                    <?php if($can_update): ?>
                      <div class="input-group">
                        ...
                        <?php echo Form::number('vendor_order_cancellation_fee', $system->vendor_order_cancellation_fee, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('app.cancellation_fee'), can_set_cancellation_fee() ? '' : 'disabled']); ?>
                      ...
                      <div class="help-block with-errors">
                        <?php if(!is_incevio_package_loaded(['wallet'])): ?>
                          <small class="text-danger">
                            <i class="fa fa-ban"></i>
                            <?php echo e(trans('help.option_dependence_module', ['dependency' => 'wallet']), false); ?>

                          </small>
                        <?php elseif(vendor_get_paid_directly()): ?>
                          <?php echo e(trans('help.disabled_when_vendor_get_paid_directly'), false); ?>

                        <?php endif; ?>
                      </div>
                    <?php else: ?>
                      <span><?php echo e($system->vendor_order_cancellation_fee, false); ?></span>
                    <?php endif; ?>
                  </div>
                </div>
              </fieldset>
              ...
              <fieldset>
                ...
                <div class="row">
                  <div class="col-sm-7">
                    <div class="form-group text-right">
                      <?php echo Form::label('social_auth', trans('app.show_social_auth') . ':', ['class' => 'with-help control-label']); ?>

                      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="left" title="<?php echo e(trans('help.social_auth'), false); ?>"></i>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'social_auth'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->social_auth ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->social_auth ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                      <span><?php echo e($system->social_auth ? trans('app.on') : trans('app.off'), false); ?></span>
                    <?php endif; ?>
                  </div>
                </div> <!-- /.row -->
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'allow_guest_checkout'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->allow_guest_checkout ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->allow_guest_checkout ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
            ...
            <div class="col-sm-6">
              <fieldset>
                ...
                <div class="row">
                  <div class="col-sm-7 text-right">
                    <div class="form-group">
                      <?php echo Form::label('show_item_conditions', trans('app.show_item_conditions') . ':', ['class' => 'with-help control-label']); ?>

                      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="left" title="<?php echo e(trans('help.show_item_conditions'), false); ?>"></i>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'show_item_conditions'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->show_item_conditions ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->show_item_conditions ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                      <span><?php echo e($system->show_item_conditions ? trans('app.on') : trans('app.off'), false); ?></span>
                    <?php endif; ?>
                  </div>
                </div> <!-- /.row -->
              ...
              <fieldset>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'show_seo_info_to_frontend'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->show_seo_info_to_frontend ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->show_seo_info_to_frontend ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
              ...
              <fieldset>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'show_address_title'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->show_address_title ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->show_address_title ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'address_show_country'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->address_show_country ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->address_show_country ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'address_show_map'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->address_show_map ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->address_show_map ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
              ...
              <fieldset>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'show_currency_symbol'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->show_currency_symbol ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->show_currency_symbol ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal text-center">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'show_space_after_symbol'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->show_space_after_symbol ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->show_space_after_symbol ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
          ...
          <?php $__currentLoopData = $payment_method_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type_id => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <?php if(!vendor_get_paid_directly() && $type_id == \App\Models\PaymentMethod::TYPE_MANUAL): ?>
                  <div class="spacer20"></div>
                  <div class="alert alert-info">
                    <strong class="text-uppercase">
                      <i class="fa fa-info-circle"></i> <?php echo e(trans('app.important'), false); ?> :
                    </strong>
                    <span><?php echo trans('messages.manual_payment_configure_help'); ?></span>
                  </div>
                <?php endif; ?>
              </div>
                ...
                <?php $__currentLoopData = $payment_providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <ul class="list-group">
                    <li class="list-group-item">
                      ...
                      <?php if(vendor_get_paid_directly() && !$payment_provider->split_money): ?>
                        <div class="spacer20"></div>
                      ...
                      <?php if(!vendor_get_paid_directly() && !\App\Models\SystemConfig::isPaymentConfigured($payment_provider->code)): ?>
                        <div class="spacer20"></div>
                        <div class="alert alert-danger">
                          <strong class="text-uppercase">
                            <i class="fa fa-exclamation-triangle"></i> <?php echo e(trans('app.alert'), false); ?> :
                          </strong>
                          <span><?php echo trans('messages.misconfigured_payment', ['payment' => $payment_provider->name]); ?></span>
                        </div>
                      <?php endif; ?>
                ...
                <div class="row">
                  <div class="col-sm-8 text-right">
                    <div class="form-group">
                      ...
                      <div class="help-block"><?php echo e(trans('help.changes_can_take_time', ['time' => get_readble_time_from_secconts(config('cache.remember.statistics'))]), false); ?></div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'google_analytic_report'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->google_analytic_report ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->google_analytic_report ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
              ...
              <fieldset>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'notify_when_vendor_registered'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->notify_when_vendor_registered ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->notify_when_vendor_registered ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'notify_new_ticket'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->notify_new_ticket ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->notify_new_ticket ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <?php if($can_update): ?>
                      <div class="handle horizontal">
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.setting.system.config.toggle', 'notify_when_dispute_appealed'), false); ?>" type="button" class="btn btn-md btn-secondary btn-toggle <?php echo e($system->notify_when_dispute_appealed ? 'active' : '', false); ?>" data-toggle="button" aria-pressed="<?php echo e($system->notify_when_dispute_appealed ? 'true' : 'false', false); ?>" autocomplete="off">
                          <div class="btn-handle"></div>
                        </a>
                      </div>
                    <?php else: ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/system/config.blade.php ENDPATH**/ ?>