<?php $__env->startSection('content'); ?>
  <?php if(\App\Models\SystemConfig::isGgoogleAnalyticReady()): ?>
    <div class="box">
      <div class="nav-tabs-custom" style="box-shadow: none;">
        <ul class="nav nav-tabs nav-justified">
          <li class="active">
            <a href="#visitors_tab" data-toggle="tab">
          ...
          <li>
            <a href="#referrals_tab" data-toggle="tab">
          ...
          <li>
            <a href="#behavior_tab" data-toggle="tab">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/report/platform/visitors.blade.php ENDPATH**/ ?>