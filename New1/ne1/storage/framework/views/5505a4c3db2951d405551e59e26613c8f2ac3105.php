        ...
        <div class="col-md-8 col-sm-offset-2 space30">
          ...
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <p class="lead text-center space50">
              <?php echo app('translator')->get('theme.nothing_found'); ?>
            </p>
          <?php endif; ?>
        </div>
...
<div class="clearfix space50"></div>
<?php /**PATH /home/dappr/public_html/test.dappr.com.au/public/themes/default/views/contents/account.blade.php ENDPATH**/ ?>