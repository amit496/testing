<?php $__env->startSection('content'); ?>
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title"><?php echo e(trans('app.users'), false); ?></h3>
      <div class="box-tools pull-right">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\User::class)): ?>
          <a href="javascript:void(0)" data-link="<?php echo e(route('admin.admin.user.create'), false); ?>" class="ajax-modal-btn btn btn-new btn-flat"><?php echo e(trans('app.add_user'), false); ?></a>
        <?php endif; ?>
      </div>
    </div> <!-- /.box-header -->
    <div class="box-body">
        ...
        <tbody id="massSelectArea">
          <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e($user->nice_name, false); ?></td>
              <td><?php echo e($user->name, false); ?></td>
              <td><?php echo e($user->email, false); ?></td>
              <td>
                <span class="label label-outline"><?php echo e(optional($user->role)->name, false); ?></span>
              </td>
              ...
              <td class="row-options">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', $user)): ?>
                  <a href="javascript:void(0)" data-link="<?php echo e(route('admin.admin.user.show', $user->id), false); ?>" class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.profile'), false); ?>" class="fa fa-user-circle-o"></i></a>&nbsp;
                <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $user)): ?>
                  ...
                  <a href="javascript:void(0)" data-link="<?php echo e(route('admin.admin.user.changePassword', $user->id), false); ?>" class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.change_password'), false); ?>" class="fa fa-lock"></i></a>&nbsp;
        ...
        <tbody>
          <?php $__currentLoopData = $trashes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                <span class="label label-outline"><?php echo e(optional($trash->role)->name, false); ?></span>
              </td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/user/index.blade.php ENDPATH**/ ?>