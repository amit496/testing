    ...
    <div class="modal-content">
        <div class="modal-body" style="padding: 0px;">
            ...
            <div class="col-md-3 nopadding" style="margin-top: 10px;">
				<img src="<?php echo e(get_storage_file_url(optional($shop->logoImage)->path, 'medium'), false); ?>" class="thumbnail" width="100%" alt="<?php echo e(trans('app.logo'), false); ?>">
			</div>
					  ...
					  <div class="box-body">
				        <table class="table">
							<tr>
								...
								<td style="width: 75%;"><?php echo e(get_formated_currency($shop->config->order_handling_cost, 2), false); ?></td>
							</tr>
...
</div> <!-- / .modal-dialog --><?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/shop/_show.blade.php ENDPATH**/ ?>