            ...
            <div class="col-md-3 space20">
                <div class="side-widget" id="cart-summary<?php echo e($cart->id, false); ?>">
                    ...
                    <?php
                        ...
                        $sub_total = $cart_total - $gst_amount + $cart->discount;
                    ?>
                    <ul class="shopping-cart-summary">
                        <li>
                            ...
                            <span>
                                ...
                                <span id="summary-total<?php echo e($cart->id, false); ?>">
                                    <?php echo e(number_format($sub_total, 2, '.', ''), false); ?>
                        ...
                        <li>
                            ...
                            <span><?php echo e(get_currency_prefix(), false); ?>
                                ...
                                <span id="summary-shipping<?php echo e($cart->id, false); ?>12"><?php echo e(number_format(0, 2, '.', ''), false); ?></span><?php echo e(get_currency_suffix(), false); ?>
                        ...
                        <li>
                            ...
                            <span><?php echo e(get_currency_prefix(), false); ?>
                                ...
                                <span id="summary-grand-total<?php echo e($cart->id, false); ?>total"><?php echo e(number_format($cart_total, 2), false); ?></span><?php echo e(get_currency_suffix(), false); ?>
