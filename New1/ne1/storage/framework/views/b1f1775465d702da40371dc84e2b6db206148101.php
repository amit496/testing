...
<?php $__env->startSection('content'); ?>
  ...
  <div class="box">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs nav-justified">
        ...
        <li class="<?php echo e(Request::input('tab') == 'unpaid' ? 'active' : '', false); ?>">
        ...
        <li class="<?php echo e(Request::input('tab') == 'unfulfilled' ? 'active' : '', false); ?>">
          ...
          <table class="table table-hover table-no-sort">
            <thead>
              <tr>
                ...
                <th><?php echo e(trans('app.model.delivery_boy'), false); ?></th>
                ...
                <tr>
                  ...
                  <td>
                    <?php if($order->deliveryBoy): ?>
                      <?php echo e($order->deliveryBoy->getName(), false); ?>

                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fulfill', $order)): ?>
                        <a data-link="<?php echo e(route('admin.order.deliveryboys', $order->id), false); ?>" class="ajax-modal-btn fa fa-edit indent10" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.change_deliveryboy'), false); ?>"></a>
                      <?php endif; ?>
                    <?php else: ?>
                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fulfill', $order)): ?>
                        <a data-link="<?php echo e(route('admin.order.deliveryboys', $order->id), false); ?>" class="ajax-modal-btn btn btn-sm btn-flat btn-default" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.assign_deliveryboy'), false); ?>">
                          <i class="fa fa-user"></i> <?php echo e(trans('app.assign'), false); ?>
                  ...
                  <?php if(Auth::user()->isFromPlatform()): ?>
                    <td><?php echo e($order->shop->getName(), false); ?></td>
                  <?php endif; ?>
                  <td><?php echo e($order->customer->getName(), false); ?></td>
                  ...
                  <td class="row-options">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fulfill', $order)): ?>
                      <?php if (! ($order->isFulfilled())): ?>
                        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.order.order.fulfillment', $order), false); ?>" class='ajax-modal-btn'>
                          <i data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.fulfill_order'), false); ?>" class="fa fa-truck"></i>
                        </a>&nbsp;
                      <?php endif; ?>
                    <?php endif; ?>

                    <a href="<?php echo e(route('admin.order.order.show', $order->id), false); ?>">
                      <i data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.open'), false); ?>" class="fa fa-expand"></i>
                    </a>&nbsp;
  ...
  <div class="box collapsed-box">
    <div class="box-header with-border">
      <h3 class="box-title">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDestroy', \App\Models\Order::class)): ?>
          <?php echo Form::open(['route' => ['admin.order.order.emptyTrash'], 'method' => 'delete', 'class' => 'data-form']); ?>
        ...
        <tbody>
          <?php $__currentLoopData = $archives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><?php echo e(get_formated_currency($archive->grand_total, 2), false); ?></td>
              ...
              <td class="row-options">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $archive)): ?>
                  <?php echo Form::open(['route' => ['admin.order.order.destroy', $archive->id], 'method' => 'delete', 'class' => 'data-form']); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/order/index.blade.php ENDPATH**/ ?>