              ...
              <div class='pricing pricing-palden'>
                <?php $__currentLoopData = $subscription_plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class='pricing-item <?php echo e($plan->featured ? 'pricing__item--featured' : '', false); ?>'>
                    ...
                    <a href="<?php echo e(route('vendor.register', $plan), false); ?>" class='pricing-action'><?php echo e(__('theme.button.choose_plan'), false); ?></a>
                  </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/_selling/default/views/index.blade.php ENDPATH**/ ?>