				        ...
				        <table class="table">
				            ...
				            <?php if($coupon->min_order_amount && $coupon->min_order_amount != 0): ?>
				                <tr>
				                	...
				                	<td><?php echo e(get_formated_currency($coupon->min_order_amount, 2), false); ?></td>
				                </tr>
				            <?php endif; ?>
			                <tr>
...
</div> <!-- / .modal-dialog --><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/coupon/_show.blade.php ENDPATH**/ ?>