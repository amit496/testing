  ...
  <header>
    <div class="container">
      <div class="intro-text">
        ...
        <a href="<?php echo e(route('vendor.register'), false); ?>" class="btn btn-primary btn-lg selling"><?php echo e(__('theme.button.selling'), false); ?></a>
  ...
  <footer class="page-footer font-small indigo pt-0">
    <div class="container">
      <ul class="quicklinks navbar nav-justified text-center">
        <li><a href="<?php echo e(route('page.open', \App\Models\Page::PAGE_ABOUT_US), false); ?>" target="_blank"><?php echo e(trans('theme.nav.about_us'), false); ?></a></li>
        <li><a href="<?php echo e(route('page.open', \App\Models\Page::PAGE_PRIVACY_POLICY), false); ?>" target="_blank"><?php echo e(trans('theme.nav.privacy_policy'), false); ?></a></li>
        <li><a href="<?php echo e(route('page.open', \App\Models\Page::PAGE_TNC_FOR_MERCHANT), false); ?>" target="_blank"><?php echo e(trans('theme.nav.term_and_conditions'), false); ?></a></li>
        <li><a href="<?php echo e(route('page.open', \App\Models\Page::PAGE_RETURN_AND_REFUND), false); ?>" target="_blank"><?php echo e(trans('theme.nav.return_and_refund_policy'), false); ?></a></li>
      </ul>
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/_selling/default/views/layouts/main.blade.php ENDPATH**/ ?>