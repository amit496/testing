        ...
        <table class="table" id="buyer-payment-detail-table">
          ...
          <tbody>
            <tr class="buyer-payment-info-head" style="background: #6DBCD4;">
              ...
              <td colspan="2"><?php echo app('translator')->get('theme.total'); ?></td>
            </tr>
              <?php
              $gst_amount = number_format($order->total - ($order->total * 100)/(100 + config('app.gst_percentage')),2);
              $sub_total = $order->total - $gst_amount  + $order->discount
            ?>

            <tr class="buyer-payment-info-body">
              <td>$<?php echo e(number_format($sub_total,  2 , '.', ''), false); ?></td>
              ...
              <td colspan="2">$<?php echo e(number_format( $order->total,  2 , '.', ''), false); ?></td>
            ...
            <tr class="order-info-head">
              ...
              <td width="20%" class="order-amount">
                <h5 class="my-1">
                  ...
                  <span  style="color:#6DBCD4;"><?php echo app('translator')->get('theme.order_amount'); ?>: </span><?php echo e('$'.number_format($order->total, 2 ,'.', ''), false); ?>
