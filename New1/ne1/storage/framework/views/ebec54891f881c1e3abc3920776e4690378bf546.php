          	...
          	<div class="box box-primary">
	            ...
	            <div class="box-body no-padding">
	              	...
	              	<div class="mailbox-controls text-center no-print">
		                <div class="btn-group">
							<?php if($message->label < \App\Models\Message::LABEL_DRAFT): ?>
								...
								<?php if($message->label == \App\Models\Message::LABEL_INBOX): ?>
									<a href="<?php echo e(route('admin.support.message.update', [$message, \App\Models\Message::STATUS_UNREAD, 'status']), false); ?>" class="btn btn-default btn-sm">
								...
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $message)): ?>
									<a href="<?php echo e(route('admin.support.message.update', [$message, \App\Models\Message::LABEL_SPAM]), false); ?>" class="btn btn-default btn-sm">
			       		           		<i class="fa fa-filter"></i> <?php echo e(trans('app.mark_as_spam'), false); ?>

			       		           	</a>

									<a href="<?php echo e(route('admin.support.message.update', [$message, \App\Models\Message::LABEL_TRASH]), false); ?>" class="btn btn-default btn-sm">
							...
							<?php else: ?>
								...
								<?php if($message->label > \App\Models\Message::LABEL_DRAFT): ?>
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $message)): ?>
										<a href="<?php echo e(route('admin.support.message.update', [$message, \App\Models\Message::LABEL_INBOX]), false); ?>" class="btn btn-default btn-sm">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/message/show.blade.php ENDPATH**/ ?>