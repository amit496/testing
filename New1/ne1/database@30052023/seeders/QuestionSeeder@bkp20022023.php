...
class QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $questions_array[] = array(
            'name' => 'Skin Colour',
            'description' => 'To build a flexible & cohesive wardrobe for you we need to make sure we get colours perfect for complexion and appearance. ',
            'type' => 'select',
            'anwer_type' => 'img',
            'multiple_select' => 'N',
            ...
            'answer' => array(
                ...
                array('answername' => 'Prefer not to say', 'image_name' => 'hair_colour_None_of_the_above.png', 'tag_id' => $tags[30]),
                array('answername' => 'Other', 'image_name' => 'eye_colour_other.png' , 'has_logn_text_ans' => 'Y'),
            ),
        );

        $questions_array[] = array(
            'description' => 'To ensure we respectfully communicate with you & build an authentic wardrobe that represents you',
            'name' => 'Hair Colour',
            'type' => 'select',
            'anwer_type' => 'img',
            'question_catogary' => $questions_category_id[2],
            ...
            'answer' => array(
                ...
                array('answername' => 'No hair', 'image_name' => 'hair_colour_None_of_the_above.png' , 'tag_id' => $tags[38]),
                array('answername' => 'Other', 'image_name' => 'eye_colour_other.png' , 'has_logn_text_ans' => 'Y'),
            ),
        );
        ...
        $questions_array[] = array(
            'name' => 'What AU size top do you typically wear?',
            'type' => 'select',
            'anwer_type' => '',
            'question_catogary' => $questions_category_id[3],
            'required' => 'Y',
        ...
        $questions_array[] = array(
            'name' => 'When purchasing <b>long sleeve tops or jackets</b> I typically find the sleeves are',
            'type' => 'select',
            'anwer_type' => '',
            'question_catogary' => $questions_category_id[3],
            'required' => 'Y',
        ...
        $questions_array[] = array(
            'name' => 'When purchasing a <b>shirt or top</b> I typically find the chest area is',
            'type' => 'select',
            'anwer_type' => '',
            'question_catogary' => $questions_category_id[3],
            'required' => 'Y',
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                array('answername' => 'Narrower than my thighs ', 'blogn_to' => 'skip_next_question'),
                array('answername' => 'In line with my thigh width'),
                array('answername' => 'Wider than my thighs'),
            ),
        );
        ...
        $questions_array[] = array(
            'name' => 'When purchasing <b>shirts or tops</b> I typically find the torso length of the top is',
            'type' => 'select',
            'anwer_type' => '',
            'question_catogary' => $questions_category_id[3],
            'required' => 'Y',
        ...
        $questions_array[] = array(
            'name' => 'When purchasing <b>full length pants</b> I typically find the length is',
            'type' => 'select',
            'anwer_type' => '',
            'question_catogary' => $questions_category_id[3],
            'required' => 'Y',
            ...
            'answer' => array(
                ...
                array('answername' => 'Fits perfectly', 'tag_id' => $tags[23]),
                array('answername' => 'Long with excess fabric & need to get hem taken up', 'tag_id' => $tags[24]),
            ),
        );

        $questions_array[] = array(
            'name' => 'When purchasing <b>fitted pants or jeans</b> I typically find the thigh area is',
            'type' => 'select',
            'anwer_type' => '',
            'question_catogary' => $questions_category_id[3],
            'required' => 'Y',
        ...
        $questions_array[] = array(
            'name' => 'What AU size shirt/top do you typically wear?',
            'type' => 'select',
            'anwer_type' => '',
            'question_catogary' => $questions_category_id[4],
            'required' => 'Y',
        ...
        $questions_array[] = array(
            ...
            'multiple_select' => 'Y',
            'answer' => array(
                array('answername' => '', 'image_name' => 'Acne_Studios.jpg'),
                array('answername' => '', 'image_name' => 'Aje.jpg'),
                array('answername' => '', 'image_name' => 'Bec_Bridge.jpg'),
                array('answername' => '', 'image_name' => 'Bul.jpg'),
                array('answername' => '', 'image_name' => 'Country_Road.jpg'),
                array('answername' => '', 'image_name' => 'Cue.jpg'),
                array('answername' => '', 'image_name' => 'David_Jones.jpg'),
                array('answername' => '', 'image_name' => 'Dion_Lee.jpg'),
                array('answername' => '', 'image_name' => 'French_connection.jpg'),
                array('answername' => '', 'image_name' => 'Ginder_Smart.jpg'),
                array('answername' => '', 'image_name' => 'Gorman.jpg'),
                array('answername' => '', 'image_name' => 'H_M.jpg'),
                array('answername' => '', 'image_name' => 'Jacqui_E.jpg'),
                array('answername' => '', 'image_name' => 'Kmart.jpg'),
                array('answername' => '', 'image_name' => 'Manning_Cartell.jpg'),
                array('answername' => '', 'image_name' => 'Myer.jpg'),
                array('answername' => '', 'image_name' => 'Portmans.jpg'),
                array('answername' => '', 'image_name' => 'Reiss.jpg'),
                array('answername' => '', 'image_name' => 'Review.jpg'),
                array('answername' => '', 'image_name' => 'Saba.jpg'),
                array('answername' => '', 'image_name' => 'Sass_Bide.jpg'),
                array('answername' => '', 'image_name' => 'Scanlan_Theodore.jpg'),
                array('answername' => '', 'image_name' => 'Seed.jpg'),
                array('answername' => '', 'image_name' => 'Sport_Girl.jpg'),
                array('answername' => '', 'image_name' => 'Sportcraft.jpg'),
                array('answername' => '', 'image_name' => 'Target.jpg'),
                array('answername' => '', 'image_name' => 'Ted_Baker.jpg'),
                array('answername' => '', 'image_name' => 'Tony_Bianco.jpg'),
                array('answername' => '', 'image_name' => 'Veronika_Maine.jpg'),
                array('answername' => '', 'image_name' => 'Victoria_Woods.jpg'),
                array('answername' => '', 'image_name' => 'Witchery.jpg'),
                array('answername' => '', 'image_name' => 'Wittner.jpg'),
                array('answername' => '', 'image_name' => 'Zara.jpg'),
                array('answername' => '', 'image_name' => 'Zimmermann.jpg'),
                array('answername' => '', 'image_name' => '0_Icon_None_of_the_above.png'),
                array('answername' => '', 'image_name' => '0_Icon_Other.png'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                array('answername' => 'I have No Idea', 'image_name' => 'other.jpg'),
                array('answername' => 'Other', 'has_logn_text_ans' => 'Y'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                array('answername' => '', 'image_name' => 'Brand_0000_Untitled design.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0001_Untitled design copy.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0002_Untitled design copy 4.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0003_Untitled design copy 3.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0004_Untitled design copy 2.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0005_Untitled design (24).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0006_Untitled design (23).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0007_Untitled design (22).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0008_Untitled design (21).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0009_Untitled design (20).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0010_Untitled design (18).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0011_Untitled design (17).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0012_Untitled design (16).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0013_Untitled design (15).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0014_Untitled design (14).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0015_Untitled design (13).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0016_Untitled design (12).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0017_Untitled design (11).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0018_Untitled design (10).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0019_Untitled design (9).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0020_Untitled design (8).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0021_Untitled design (7).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0022_Untitled design (6).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0023_Untitled design (5).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0024_Untitled design (4).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0025_Untitled design (3).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0026_Untitled design (2).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0027_Untitled design (1).jpg'),
                array('answername' => '', 'image_name' => 'Brand_0028_Ted Baker.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0029_Target.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0030_Sportscraft.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0031_Saba.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0032_Rodd _ Gunn.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0033_Reiss.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0034_Ralph Lauren.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0035_Polotix.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0036_Patagonia.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0037_Nike.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0038_Myer.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0039_MJ Bale.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0040_Marcs.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0041_Levi_s.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0042_Kmart BlackWhite.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0043_Industrie.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0044_Hugo Boss.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0045_H_M.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0046_French Connection.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0047_David Jones.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0048_Country Road.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0049_COS.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0050_Converse.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0051_Calibre.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0052_Aquila.jpg'),
                array('answername' => '', 'image_name' => 'Brand_0053_Acne BlackWhite.jpg'),
                array('answername' => 'Other', 'has_logn_text_ans' => 'Y'),
                // array('answername' => 'brand 4', 'image_name' => 'brand_4.jpg'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                array('answername' => 'High rise', 'image_name' => 'high.png'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                array('answername' => 'T-shirt sleeve', 'image_name' => 'T-Shirt_sleeve.jpg'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                // array('answername' => 'Stiletto', 'image_name' => 'Stiletto.jpg'),
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                array('answername' => 'High heel', 'image_name' => 'High_heel.jpg'),
                array('answername' => 'Mid heel', 'image_name' => 'women_mid_heel_1.png'),
                array('answername' => 'Low heel', 'image_name' => 'low_dappr_womens_shoes.png'),
                array('answername' => 'No heel', 'image_name' => 'No_heel.jpg'),
                array('answername' => "Don't include shoes in my deliveries", 'image_name' => "Don't_include_shoes_in_my_deliveries.png"),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                array('answername' => "I don't wear jewellery", 'image_name' => "0_Icon_I_don't_wear_jewellery.png", 'skip_question_id' => $q_b_rand_no),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                array('answername' => 'Classic tee', 'image_name' => 'Top_Style_0002_PoloShirt.jpg' ,'skip_question_id' => $q_b_rand_no),
        ...
        $questions_array[] = array(
            ...
            'skip_id' => $q_b_rand_no,
            'answer' => array(
                // array('answername' => 'Yes', 'blogn_to' => 'answer_id'),
                // array('answername' => 'No', 'blogn_to' => 'answer_id'),
                // array('answername' => 'Suit 1', 'image_name' => 'other.jpg'),
                // array('answername' => 'Suit 2', 'image_name' => 'other.jpg'),
                // array('answername' => 'Suit 3', 'image_name' => 'other.jpg'),
                // array('answername' => 'Suit 4', 'image_name' => 'other.jpg'),
                ...
                // array('answername' => 'Suit 2', 'image_name' => 'Suiting_0001_TexturedFabric.jpg'),
                // array('answername' => 'Suit 3', 'image_name' => 'Suiting_0002_StatementFabric.jpg'),
                // array('answername' => 'Suit 4', 'image_name' => 'Suiting_0003_SingleBreasted.jpg'),
                // array('answername' => 'Suit 5', 'image_name' => 'Suiting_0004_MatteFabric.jpg'),
                // array('answername' => 'Suit 7', 'image_name' => 'Suiting_0006_DoubleBreasted.jpg'),
                // array('answername' => 'Suit 13', 'image_name' => 'Suiting_0012_Dappr_Mens_(3).jpg'),
                // array('answername' => 'Suit 14', 'image_name' => 'Suiting_0013_Dappr_Mens_(2).jpg'),
                // array('answername' => 'Suit 15', 'image_name' => 'Suiting_0014_Dappr_Mens_(1).jpg'),
                // array('answername' => 'Suit 16', 'image_name' => 'Suiting_0015_3pieceblack.jpg'),
                // array('answername' => 'Suit 17', 'image_name' => 'Suiting_0016_3piece.jpg'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'multiple_select' => 'Y',
            'answer' => array(
                // array('answername' => 'Shoes 1', 'image_name' => 'other.jpg'),
                // array('answername' => 'Shoes 2', 'image_name' => 'other.jpg'),
                // array('answername' => 'Shoes 3', 'image_name' => 'other.jpg'),
                // array('answername' => 'Shoes 4', 'image_name' => 'other.jpg'),
                ...
                array('answername' => 'Other', 'has_logn_text_ans' => 'Y'),
                // array('answername' => 'Shoes 7', 'image_name' => 'Shoes_0006_Dappr_Mens_(6).jpg'),
                // array('answername' => 'Shoes 8', 'image_name' => 'Shoes_0007_Dappr_Mens_(5).jpg'),
                // array('answername' => 'Shoes 9', 'image_name' => 'Shoes_0008_Dappr_Mens_(3).jpg'),
                // array('answername' => 'Shoes 10','image_name' => 'Shoes_0009_Dappr_Mens_(2).jpg'),
                // array('answername' => 'Shoes 11','image_name' => 'Shoes_0010_Dappr_Mens_(1).jpg'),
                // array('answername' => 'Shoes 12','image_name' => 'Shoes_0011_CasualBoot.jpg'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'multiple_select' => 'Y',
            'answer' => array(
                // array('answername' => 'Accessories 1', 'image_name' => 'Accessories_0000_TieBar.jpg'),
                // array('answername' => 'Accessories 2', 'image_name' => 'Accessories_0001_TieBar.jpg'),
                ...
                array('answername' => 'Other', 'has_logn_text_ans' => 'Y'),
                // array('answername' => 'Accessories 5', 'image_name' => 'Accessories_0004_Scarf.jpg'),
                // array('answername' => 'Accessories 6', 'image_name' => 'Accessories_0005_PocketSquare.jpg'),
                // array('answername' => 'Accessories 8', 'image_name' => 'Accessories_0007_Hat.jpg'),
                // array('answername' => 'Accessories 10', 'image_name' => 'Accessories_0009_Dappr_Mens_(10).jpg'),
                // array('answername' => 'Accessories 12', 'image_name' => 'Accessories_0011_Dappr_Mens_(8).jpg'),
                // array('answername' => 'Accessories 15', 'image_name' => 'Accessories_0014_Dappr_Mens_(5).jpg'),
                // array('answername' => 'Accessories 16', 'image_name' => 'Accessories_0015_Dappr Mens_(3).jpg'),
                // array('answername' => 'Accessories 19', 'image_name' => 'Accessories_0017_Dappr_Mens_(1).jpg'),
                // array('answername' => 'Accessories 20', 'image_name' => 'Accessories_0018_CuffLinks.jpg'),
                // array('answername' => 'Accessories 21', 'image_name' => 'Accessories_0019_Briefcase.jpg'),
                // array('answername' => 'Accessories 23', 'image_name' => 'Accessories_0021_Belt.jpg'),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                // array('answername' => 'Black', 'image_name' => 'black.jpg'),
                // array('answername' => 'Beige', 'image_name' => 'beige.jpg'),
                // array('answername' => 'Blue', 'image_name' => 'blue-wear.jpg'),
                // array('answername' => 'Brown', 'image_name' => 'brown.jpg'),
                // array('answername' => 'Green', 'image_name' => 'green-wear.jpg'),
                // array('answername' => 'Burgundy', 'image_name' => 'burgundy.jpg'),
                // array('answername' => 'Grey-wear', 'image_name' => 'grey-wear.jpg'),
                // array('answername' => 'Navy', 'image_name' => 'navy.jpg'),
                // array('answername' => 'Metalic', 'image_name' => 'metalic.png'),
                // array('answername' => 'Orange', 'image_name' => 'orange.png'),
                // array('answername' => 'Pink', 'image_name' => 'pink.jpg'),
                // array('answername' => 'Purple', 'image_name' => 'purple.jpg'),
                // array('answername' => 'Red', 'image_name' => 'red.jpg'),
                // array('answername' => 'Tan', 'image_name' => 'tan.png'),
                // array('answername' => 'Teal', 'image_name' => 'teal.jpg'),
                // array('answername' => 'White', 'image_name' => 'white.jpg'),
                // array('answername' => 'Yellow', 'image_name' => 'yellow.png'),
                // array('answername' => 'I like all colours', 'image_name' => ''),
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                // array('answername' => '', 'image_name' => 'flat_matte.jpg'),
                // array('answername' => 'Abstract', 'image_name' => 'abstract.jpg'),
                // array('answername' => 'Animal Black White', 'image_name' => 'animal_black_White.jpg'),
                // array('answername' => 'Birdseye', 'image_name' => 'birdseye.jpg'),
                // array('answername' => 'Birdseye', 'image_name' => 'birdseye_2.jpg'),
                // array('answername' => 'Dots', 'image_name' => 'dots.jpg'),
                // array('answername' => 'Flat Matte', 'image_name' => 'flat_matte_2.jpg'),
                // array('answername' => 'Floral', 'image_name' => 'floral.jpg'),
                // array('answername' => 'Floral', 'image_name' => 'floral_2.jpg'),
                // array('answername' => 'I like all patterns', 'image_name' => ''),
                // array('answername' => 'I don\'t like any patterns', 'image_name' => ''),
                array('answername' => 'Animal Black White', 'image_name' => 'Fabric_Patterns_0021_Animal_Black_White.jpg'),
                array('answername' => 'Abstract', 'image_name' => 'Fabric_Patterns_0022_Abstract.jpg'),
                // array('answername' => 'Abstract', 'image_name' => 'Fabric_Patterns_0023_Abstract_2.jpg'),          
                // array('answername' => 'Birdseye', 'image_name' => 'Fabric_Patterns_0019_Birdseye.jpg'),
                // array('answername' => 'Birdseye', 'image_name' => 'Fabric_Patterns_0020_Birdseye_2.jpg'),
                array('answername' => 'Critter Insect', 'image_name' => 'Fabric_Patterns_0000_xCritter_Insect.jpg'),
                // array('answername' => 'Dots', 'image_name' => 'Fabric_Patterns_0018_Dots.jpg'),
                // array('answername' => 'Floral', 'image_name' => 'Fabric_Patterns_0015_Floral.jpg'),
                // array('answername' => 'Floral', 'image_name' => 'Fabric_Patterns_0016_Floral_2.jpg'),
                // array('answername' => 'Flat Matte', 'image_name' => 'Fabric_Patterns_0017_Flat_Matte.jpg'),
                // array('answername' => 'Grid', 'image_name' => 'Fabric_Patterns_0013_Grid.jpg'),
                // array('answername' => 'Gingham', 'image_name' => 'Fabric_Patterns_0014_Gingham.jpg'),
                // array('answername' => 'Herringbone', 'image_name' => 'Fabric_Patterns_0011_Herringbone.jpg'),
                // array('answername' => 'Herringbone', 'image_name' => 'Fabric_Patterns_0012_Herringbone_1.jpg'),
                array('answername' => 'Plaid', 'image_name' => 'Fabric_Patterns_0006_Plaid.jpg'),
                // array('answername' => 'Plaid', 'image_name' => 'Fabric_Patterns_0007_Plaid_1.jpg'),
                // array('answername' => 'Pinstripe', 'image_name' => 'Fabric_Patterns_0008_Pinstripe.jpg'),
                array('answername' => 'Paisley', 'image_name' => 'Fabric_Patterns_0009_Paisley.jpg'),
                // array('answername' => 'Paisley', 'image_name' => 'Fabric_Patterns_0010_Paisley_2.jpg'),
                array('answername' => 'Stripes', 'image_name' => 'Fabric_Patterns_0005_Stripes.jpg'),
                // array('answername' => 'Tattersall', 'image_name' => 'Fabric_Patterns_0003_Tattersall.jpg'),
                // array('answername' => 'Tartan', 'image_name' => 'Fabric_Patterns_0004_Tartan.jpg'),
                array('answername' => 'Womens Floral', 'image_name' => 'Fabric_Patterns_0001_Womens_Floral.jpg'),
                array('answername' => 'Polkadots', 'image_name' => 'polka_dot.png'),
                // array('answername' => 'Windowpane', 'image_name' => 'Fabric_Patterns_0002_Windowpane.jpg'),
                array('answername' => 'I like all patterns', 'image_name' => ''),
                array('answername' => 'I don\'t like any patterns', 'image_name' => ''),
            ),
        );
        ...
        $questions_array[] = array(
            ...
            'answer' => array(
                ...
                // array('answername' => 'Abstract', 'image_name' => '1_Abstract.jpg'),
                // array('answername' => 'Gingham', 'image_name' => 'Gingham.jpg'),
                // array('answername' => 'matte', 'image_name' => 'matte.jpg'),
                // array('answername' => 'Paisley', 'image_name' => 'Paisley.jpg'),
                // array('answername' => 'Pinstripe', 'image_name' => 'Pinstripe.jpg'),
                // array('answername' => 'Spot', 'image_name' => 'Spot.jpg'),
                // array('answername' => 'WindowPane', 'image_name' => 'WindowPane.jpg'),
                ...
                array('answername' => 'I like all patterns', 'image_name' => 'men_I_like_all__pattern.png'),
                array('answername' => 'I don\'t like any patterns', 'image_name' => ''),
