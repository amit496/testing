...
<input type="hidden" value="<?php echo e($customer_give_question_get_all_ans, false); ?>" id="all_text_answer">
<div class="container-fluid stf_outer_body stylist_step_frontend stf_questeions_screen_wrappr" style="margin:-40px 0 0 0; display: <?php if(isset($show_question_answer_screen)) { echo $show_question_answer_screen;}else { echo 'none'; } ?>">
