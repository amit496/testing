        ...
        <table class="table" id="buyer-payment-detail-table">
          ...
          <tbody>
            <tr class="buyer-payment-info-head" style="background: #6DBCD4;">
              <td><?php echo app('translator')->get('theme.amount'); ?></td>
              <td><?php echo app('translator')->get('theme.shipping_cost'); ?></td>
              
              <td><?php echo app('translator')->get('theme.gst'); ?></td>
              <td><?php echo app('translator')->get('theme.company_contribution'); ?></td>
              <td><?php echo app('translator')->get('theme.total'); ?></td>
            </tr>

            <tr class="buyer-payment-info-body">
              <td>$<?php echo e(number_format($order->total,  2 , '.', ''), false); ?></td>
              <td>$<?php echo e(number_format($order->shipping + $order->handling,  2 , '.', ''), false); ?></td>
              
              <td>$<?php echo e(number_format($order->taxes,  2 , '.', ''), false); ?></td>
              <td>$<?php echo e(number_format($order->discount,  2 , '.', ''), false); ?></td>
              <td>$<?php echo e(number_format($order->grand_total,  2 , '.', ''), false); ?></td>
            ...
            <tr class="buyer-payment-info-head" style=" background: #6DBCD4;">
              <td colspan="2"><?php echo app('translator')->get('theme.total_amount'); ?></td>
              <td colspan="2"><?php echo app('translator')->get('theme.payment_method'); ?></td>
              <td colspan="2"><?php echo app('translator')->get('theme.status'); ?></td>
            </tr>

            <tr class="buyer-payment-info-body">
              
              <td colspan="2">$<?php echo e(number_format($order->grand_total,  2 , '.', ''), false); ?></td>
            ...
            <tr class="order-info-head">
              ...
              <td width="20%" class="order-amount">
                <h5 class="my-1">
                  ...
                  <span  style="color:#6DBCD4;"><?php echo app('translator')->get('theme.order_amount'); ?>: </span><?php echo e('$'.number_format($order->grand_total, 2 ,'.', ''), false); ?>
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/default/views/contents/order_detail.blade.php ENDPATH**/ ?>