    ...
    <section class="sidebar">
        ...
        <?php else: ?>
            <ul class="sidebar-menu">
                ...
                <?php if(Auth::user()->isAdmin()): ?>
                    <li
                        class="treeview <?php echo e(Request::is('admin/promotions*') || Request::is('admin/flashdeal*') ? 'active' : '', false); ?>">
                        <a href="javascript:void(0)">
                ...
                <?php if(1): ?>
                    <li class="treeview <?php echo e(Request::is('admin/setting*') ? 'active' : '', false); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('index', \App\Models\Tax::class)): ?>
...
</aside><?php /**PATH C:\wamp64\www\hype-dappr\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>