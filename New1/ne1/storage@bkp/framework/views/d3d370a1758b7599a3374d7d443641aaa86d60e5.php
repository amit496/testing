  ...
  (function($, window, document) {
    $(document).ready(function() {
      ...
      $('.payment-option').on('ifChecked', function(e) {
        ...
        // Razorpay form
        if ('razorpay' == code) {
          $('#pay-now-btn-txt').html('<?php echo trans('theme.button.pay_now'); ?>');
        }
      ...
      $("form[name='checkoutForm']").on('submit', function(e) {
        ...
        if ($(".has-error").length) {
          <?php echo $__env->make('theme::layouts.notification', ['message' => trans('theme.notify.fill_required_info'), 'type' => 'warning', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          return;
        }
        ...
        if (payment_method == 'stripe') {
          ...
          <?php if(is_incevio_package_loaded('razorpay')): ?>
            ...
            var request = $.ajax({
            url: "<?php echo e(isset($cart)? route('razorpay.payment.request', $cart): (isset($one_checkout_form)? route('razorpay.payment.request', 'all_checkout'): route('razorpay.payment.request')), false); ?>",
            type: 'POST'
            });
            ...
            */
            ...
            response.modal = {
            ondismiss: function() {
            <?php echo $__env->make('theme::layouts.notification', ['message' => trans('theme.notify.payment_failed'), 'type' => 'warning', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            },
            ...
            <?php echo $__env->make('theme::layouts.notification', ['message' => trans('jrfpay::lang.bad_request'), 'type' => 'warning', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            });
          <?php endif; ?>
    ...
    function submitJrfPayRequest() {
      ...
      var request = $.ajax({
        url: "<?php echo e(config('jrfpay.routes') ? route(config('jrfpay.routes.payment_request')) : '#', false); ?>",
        type: 'POST',
        data: {
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/scripts/checkout.blade.php ENDPATH**/ ?>