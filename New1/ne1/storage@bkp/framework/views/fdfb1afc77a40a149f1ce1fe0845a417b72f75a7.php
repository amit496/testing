<?php if(Auth::user()->isSubscribed() && !Auth::user()->shop->hide_trial_notice): ?>
  ...
  <?php elseif($subscription && $subscription->provider == 'wallet' && $subscription->active()): ?>
    <div class="alert alert-success alert-dismissible">
      ...
      <?php if(Auth::user()->isMerchant()): ?>
        <span class="pull-right">
          <a href="<?php echo e(route('merchant.wallet.deposit.form'), false); ?>" class="btn btn-sm bg-navy"><?php echo e(trans('wallet::lang.deposit_fund'), false); ?></a>
        </span>
      <?php endif; ?>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/partials/_subscription_notice.blade.php ENDPATH**/ ?>