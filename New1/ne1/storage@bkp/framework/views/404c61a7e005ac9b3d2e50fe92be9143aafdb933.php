    ...
    <div class="copyright-area hide-bottom"
      style="display: <?php if(isset($show_footer_qa_incomplete_edit_time)) { echo $show_footer_qa_incomplete_edit_time; }  else if(isset($hide_bottom)) { echo $hide_bottom; } else { echo 'block'; } ?>;">
      ...
      </div> <!-- /.copyright-area --><?php /**PATH /home/dappr/public_html/test.dappr.com.au/public/themes/default/views/nav/copyright.blade.php ENDPATH**/ ?>