<div class="box">
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
      <?php if(Gate::allows('create', \App\Models\Order::class) || Gate::allows('create', \App\Models\Cart::class)): ?>
        <a href="javascript:void(0)" data-link="<?php echo e(route('admin.order.order.searchCutomer'), false); ?>" class="ajax-modal-btn btn btn-new btn-flat">
          <i class="fa fa-plus"></i> <?php echo e(trans('app.add_order'), false); ?>
  ...
  <div class="box-body">
    <table class="table table-hover table-no-option">
      <thead>
        <tr>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDelete', \App\Models\Cart::class)): ?>
            <th class="massActionWrapper">
              ...
              <div class="btn-group ">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li>
                    <a href="javascript:void(0)" data-link="<?php echo e(route('admin.order.cart.massTrash'), false); ?>" class="massAction" data-doafter="reload">
                      <i class="fa fa-trash"></i> <?php echo e(trans('app.trash'), false); ?>

                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" data-link="<?php echo e(route('admin.order.cart.massDestroy'), false); ?>" class="massAction" data-doafter="reload">
                      <i class="fa fa-times"></i> <?php echo e(trans('app.delete_permanently'), false); ?>
      ...
      <tbody id="massSelectArea">
        <?php $__currentLoopData = $cart_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td><?php echo e(get_formated_currency($cart_list->grand_total, 2), false); ?></td>
            <td class="row-options">
              <div class="btn-group">
                <?php if(Gate::allows('create', \App\Models\Order::class) || Gate::allows('update', $cart_list)): ?>
...
<?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/partials/_cart_list.blade.php ENDPATH**/ ?>