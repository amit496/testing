        ...
        <div class="me-info-block">
          ...
          <div class="my-info">
            <div class="name">
              ...
              <a href="<?php echo e(route('account', 'account'), false); ?>" class="small indent10"><i class="fas fa-edit" data-toggle="tooltip" data-title="<?php echo e(trans('theme.edit_account'), false); ?>"></i></a>
            </div>
            <div class="messages">
              <span>
          ...
          <div class="pull-right">
            <a href="<?php echo e(url('/'), false); ?>" class="btn btn-primary flat">
              <i class="fas fa-shopping-cart"></i> <?php echo app('translator')->get('theme.button.continue_shopping'); ?>
            </a>

            <?php if (! ($dashboard->shippingAddress)): ?>
              <a href="<?php echo e(route('account', 'account'), false); ?>#address-tab" class="btn btn-default flat">
                <i class="fas fa-truck"></i> <?php echo app('translator')->get('theme.add_shipping_address'); ?>
              </a>
            <?php endif; ?>
          </div>
        </div>
        ...
        <ul>
          <li>
            <a href="<?php echo e(route('account', 'orders'), false); ?>">
              ...
              <span class="d"><i class="fas fa-shopping-cart"></i> <?php echo app('translator')->get('theme.orders'); ?></span>
            </a>
          </li>
          <li>
            <a href="<?php echo e(route('account', 'wishlist'), false); ?>">
              <span class="v"><?php echo e($dashboard->wishlists_count, false); ?></span>
              <span class="d"><i class="fas fa-heart"></i> <?php echo app('translator')->get('theme.wishlist'); ?></span>
            </a>
          </li>
          <li>
            <a href="<?php echo e(route('account', 'messages'), false); ?>">
              <span class="v"><?php echo e($dashboard->messages_count, false); ?></span>
              <span class="d"><i class="fas fa-envelope"></i> <?php echo app('translator')->get('theme.unread_messages'); ?></span>
            </a>
          </li>
          <li>
            <a href="<?php echo e(route('account', 'coupons'), false); ?>">
              <span class="v"><?php echo e($dashboard->coupons_count, false); ?></span>
              <span class="d"><i class="fas fa-tags"></i> <?php echo app('translator')->get('theme.coupons'); ?></span>
            </a>
          </li>
          <li class="last">
            <a href="<?php echo e(route('account', 'disputes'), false); ?>">
              <span class="v"><?php echo e($dashboard->disputes_count, false); ?></span>
              <span class="d"><i class="fas fa-envelope"></i> <?php echo app('translator')->get('theme.disputes'); ?></span>
            </a>
          </li>
        </ul>
      </div><!-- .my-info-details -->
      ...
      <thead>
        <tr class="text-muted">
          ...
          <th>
            ...
            <i class="fas fa-question-circle pull-right" data-toggle="tooltip" data-title="<?php echo e(trans('theme.item_count'), false); ?>"></i>
          </th>
      ...
      <tbody>
        <?php $__currentLoopData = $dashboard->orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td>
              <img src="<?php echo e(get_storage_file_url(optional($order->shop->logoImage)->path, 'tiny_thumb'), false); ?>" class="img-circle" alt="<?php echo e($order->shop->name, false); ?>" data-toggle="tooltip" data-title="<?php echo e($order->shop->name, false); ?>">
          ...
          <?php if($wish->inventory): ?>
            <tr>
              <td>
                ...
                <a class="product-link" href="<?php echo e(route('show.product', $wish->inventory->slug), false); ?>"><?php echo \Illuminate\Support\Str::limit($wish->inventory->title, 35); ?></a>
              </td>
              <td>
                <a class="btn btn-primary btn-xs flat" href="<?php echo e(route('direct.checkout', $wish->inventory->slug), false); ?>">
                  <i class="fas fa-rocket"></i> <?php echo app('translator')->get('theme.button.buy_now'); ?>
                </a>
              </td>
            </tr>
          ...
          <?php elseif($wish->product): ?>
            ...
            <tr>
              <td>
                ...
                <a class="product-link" href="<?php echo e(route('show.offers', $wish->product->slug), false); ?>" class="btn btn-sm btn-link"><?php echo \Illuminate\Support\Str::limit($wish->product->name, 35); ?></a>
              </td>
              <td>
                <a class="btn btn-primary btn-xs flat" href="<?php echo e(route('show.offers', $wish->product->slug), false); ?>">
                  <?php echo app('translator')->get('theme.view_more_offers', ['count' => $wish->product->inventories_count]); ?>
                </a>
              </td>
            </tr>
          <?php endif; ?>
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/default/views/contents/dashboard.blade.php ENDPATH**/ ?>