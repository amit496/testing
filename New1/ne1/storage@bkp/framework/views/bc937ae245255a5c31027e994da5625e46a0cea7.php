        ...
        <ul class="shopping-cart-summary ">
          ...
          <li>
            ...
            <span><?php echo e(get_currency_prefix(), false); ?>
              ...
              <span id="summary-total<?php echo e($cart->id, false); ?>" class="item-total<?php echo e($cart->id, false); ?>"><?php echo e(number_format($cart->total, 2, '.', ''), false); ?></span><?php echo e(get_currency_suffix(), false); ?>
          ...
          <li id="discount-section-li<?php echo e($cart->id, false); ?>" style="display: <?php if($cart->discount > 0){echo'none' ;}else{echo 'block' ;}?>">
            <span><?php echo e(trans('theme.employee_contribution'), false); ?>

              
              <em id="summary-discount-name<?php echo e($cart->id, false); ?>" class="small text-muted">$<?php echo e($cart->coupon ? number_format($cart->discount, 0, '.', '') : number_format(0, 2, '.', ''), false); ?> off by company ($<?php echo e($cart->coupon ? number_format($cart->discount, 0, '.', '') : number_format(0, 2, '.', ''), false); ?>)</em>
            </span>
          ...
          <li>
            ...
            <span class="lead"><?php echo e(get_currency_prefix(), false); ?>
              ...
              <span id="summary-grand-total<?php echo e($cart->id, false); ?>"><?php echo e(number_format($cart->calculate_grand_total(), 2, '.', ''), false); ?></span><?php echo e(get_currency_suffix(), false); ?>
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/default/views/contents/checkout_page.blade.php ENDPATH**/ ?>