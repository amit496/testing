...
<?php $__env->startSection('content'); ?>
    <?php if(session('success')): ?>
        <div class="alert <?php echo e(Session::get('alert-class', 'alert-info'), false); ?> alert-dismissible fade show"><?php echo e(session('success'), false); ?>

            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
    <?php endif; ?>
    <?php if(session('error')): ?>
        <div class="alert <?php echo e(Session::get('alert-class', 'alert-info'), false); ?> alert-danger  fade show"> <?php echo e(session('error'), false); ?>
                            ...
                            <?php if($list->count() > 0): ?>
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="stf_outer_body_table_style">
                                        <td class="stf_outer_body_img"><div class="stf_outer_body_img"> <img src="<?php echo e($profile_img_url, false); ?>" alt="" style="border-radius:500%"></div></td>
                                        <td class="c-text-left"><?php echo e($customer_name, false); ?></td>
                                        <td class="c-text-left"><?php echo e($company_name, false); ?></td>
                                        <td class="c-text-left"><?php echo $task_due_date_info; ?></td>
                                        <td class="c-text-left"><?php echo $reveal_status_button; ?></td>
                                        <td class="c-text-left"><?php echo $daysleft_info; ?></td>
                                        <td class="c-text-left"><?php echo $action_status; ?></td>
                                        <td class="c-text-left"><?php echo $reveal_action_btn; ?></td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/stylist_form/customer_request_list.blade.php ENDPATH**/ ?>