              ...
              <tr>
                ...
                <td class="row-options">
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cancel', $cancellation->order)): ?>
                    <a href="javascript:void(0)" data-link="<?php echo e(route('admin.order.cancellation.create', $cancellation->order), false); ?>" class='ajax-modal-btn btn btn-default btn-sm'>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/order/approvals.blade.php ENDPATH**/ ?>