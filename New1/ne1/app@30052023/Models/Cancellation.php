...
class Cancellation extends BaseModel
{
    ...
    { 
        if(isset($_REQUEST['request_type']) && $_REQUEST['request_type'] =='approve')
        {
            ...
            $this->forceFill(['status' => static::STATUS_PENDING, 'approve_items' =>$approved_items])->save();
        }
        ...
        if(isset($_REQUEST['request_type']) && $_REQUEST['request_type'] =='decline')
        {
            ...
            $this->forceFill(['status' => static::STATUS_PENDING,'decline_item' => $declined_items])->save();            
        }
    ...
    public function complete()
    {
        if(isset($_REQUEST['request_type']) && $_REQUEST['request_type'] =='approve')
        {
            ...
            $this->forceFill(['status' => static::STATUS_COMPLETE, 'approve_items' =>$approved_items])->save();
        }
        ...
        if(isset($_REQUEST['request_type']) && $_REQUEST['request_type'] =='decline')
        {
            ...
            $this->forceFill(['status' => static::STATUS_COMPLETE,'decline_item' => $declined_items])->save();            
        }
        $this->order->cancel($this->isPartial());
    }
