            ...
            elseif(isset($stylist_call_complete))
            {
                ...
                if(isset($booking_obj))
                {
                    ...
                    {   
                        ...
                        else if(($booking_obj->status =='dispatched') && ($reveal_info_has->status =='dispatched') && isset($order_data_info) && ($order_data_info->order_status_id == 6) && ($today <= $update_14_days))
                        { 
                        ...
                        else if(($booking_obj->status =='return_initiated') && ($reveal_info_has->status =='return_initiated') && isset($order_data_info) && ($order_data_info->order_status_id == 6) && isset($cancel_data) && ($cancel_data->status == 5) && (strtotime($cancel_data->created_at) <= strtotime($update_14_days)))
                        {
                        ...
                        else if(($booking_obj->status == 'dispatched') && ($reveal_info_has->status == 'dispatched') && isset($order_data_info) && ($order_data_info->order_status_id == 6) && !isset($cancel_data) && ($today > $update_14_days) )
                        {
                            $html = '<div class="container d-flex  reveal_booked_appointment_info"><div class="col-lg-5 col-lg-7 card  mb-5 border-0 m-auto"><div class=""><div class="mb-4 dappr-text-h pt-4"><h3>Welcome ' . $name .'</h3></div><span style="border-bottom:2px solid black; font-weight:600; padding-bottom:5px;">Reveal coming soon</span>';
                        ...
                        elseif(($today<=  $booking_obj_3_month)&& ($today >  $booking_obj_2_month_27_days) && ($today >  $booking_obj_2_month_17_days) && ($today >  $booking_obj_2_month))
                        {
