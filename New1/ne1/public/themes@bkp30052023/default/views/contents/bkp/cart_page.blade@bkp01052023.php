            ...
            <div class="col-md-9">
                ...
                <table class="table table shopping-cart-item-table" id="table{{ $cart->id }}">
                    ...
                    <tfoot style="display:none;">
                        <tr>
                            <td colspan="6">
                                <div class="input-group full-width" style="z-index:-1">
                                    <span class="input-group-addon flat">
                                        <i class="fa fa-ticket"></i>
                                    </span>

                                    {{-- <input name="coupon" value="{{ $cart->coupon ? $cart->coupon->code : null }}"
                                        id="coupon{{ $cart->id }}" class="form-control flat" type="text"
                                        placeholder="@lang('theme.placeholder.have_coupon_from_seller')"> --}}
                                    <input name="coupon" value=""
                                        id="coupon{{ $cart->id }}" class="form-control flat" type="text"
                                        placeholder="@lang('theme.placeholder.have_coupon_from_seller')">

                                    <span class="input-group-btn">
                                        <button class="btn btn-default flat apply_seller_coupon" type="button"
                                            data-cart="{{ $cart->id }}">@lang('theme.button.apply')</button>
                                    </span>
                                </div><!-- /input-group -->
                            </td>
                        </tr>
                ...
                <div class="side-widget" id="cart-summary{{ $cart->id }}">
                    ...
                    <ul class="shopping-cart-summary">
                        ...
                        <li>
                            ...
                            <span>{{ get_currency_prefix() }}
                                <span id="summary-grand-total{{ $cart->id }}">{{ number_format(0, 2, '.', '')
                                    }}</span>{{ get_currency_suffix() }}
                            </span>
                        </li>
                    </ul>
