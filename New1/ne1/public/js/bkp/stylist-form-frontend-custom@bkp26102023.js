...
$(document).ready(function () {
	...
	let store_last_answer = $('#all_text').val();
	let  searchString = dapper_base_url + '/stylist/customer/info';
	console.log('store_last_answer:- ' + store_last_answer);
	if(store_lasr_answer == 'all')
	{
	...
	else
	{
		...
		$('#edit_question').attr('href', searchString+ '?q=show_quesiton_answer_edit_screen' );
	}
