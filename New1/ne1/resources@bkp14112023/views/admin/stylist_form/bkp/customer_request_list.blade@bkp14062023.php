                            ...
                            @foreach($list as $key => $info)
                                ...
                                @php
                                    ...
                                    if ($reveal_list->isNotEmpty()){
                                        ...
                                        else if(!is_array($reveal_has_not_draft) && !empty($getreveal_has_not_draft_reveal) && ($reveal_has_not_draft->status == 'draft') && $reveal_status == 'not_started')
                                        {
