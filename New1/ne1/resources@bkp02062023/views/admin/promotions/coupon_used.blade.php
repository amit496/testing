      ...
      <table class="table table-hover table-no-sort">
        ...
        <tbody id="massSelectArea">
         ...
         <tr>
            ...
            <td>{{ number_format($coupon_data->total,2,) + number_format($coupon_data->handling,2,) +  number_format($coupon_data->packaging,2,) + number_format($coupon_data->shipping,2,)}}</td>
