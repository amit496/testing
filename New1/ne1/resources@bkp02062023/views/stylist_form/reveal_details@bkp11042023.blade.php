           ...
           if($img_src == ''){
            ...
            $product_details_html .= $alernate_tag.'</div>
             <div class="col-md-6 dappr-altenative-style">
                ...
                <button type="button" class="btn btn-dark add_to_card '.$product_is_selected_checked_class.'" name="stylist[\'product_in_cart\'][]"  value="'.$product_obj->id.'" style="display:'.$product_add_cart_btn_display.'">ADD TO BAG</button>
               <input type="checkbox" class="style-field-hide  add_to_cart_product_select_'.$product_obj->id.'" name="product_select['.$product_obj->id.']" '.$product_is_selected_checked.'>
                ...
                <button type="button" class="btn btn-dark remove_add_to_card " name="stylist[\'product_in_cart_remove\'][]" style="display:'.$product_remove_add_cart_btn_display.'" value="'.$product_obj->id.'" >REMOVE FROM BAG</button>
   ...
   <div class=" py-4 px-4 botom-style-previous ">
      ...
      if(count($products_details) == $sty_j){
         $product_details_html .= ' <a href="javascript:void(0)" class="text-decoration-none px-0">
            <div class="p-3 my-3 text-center proceed-checkout-style m-auto  w-100"style="   " onclick="stylist_proceed_checkout_page(this)">123 PROCEED TO CHECKOUT</div>
            </a>';
     }
                        ...
                        <div class="col-md-8 ">
                           <div class="row  stf_products_list mx-md-4">
                              ...
                              <a href="javascript:void(0)" class="text-decoration-none px-0 sty_mobile_hide">
                                 <div class="p-3 my-3 text-center proceed-checkout-style m-auto  w-100" onclick="stylist_proceed_checkout_page(this)">PROCEED TO CHECKOUT 11 22</div>
                              </a>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="px-md-3">
                     ...
                     <div class="row pt-md-5 products_feedback_top_section">
                        ...
                        <div class="col-md-4 px-lg-4 sm-p-my-t offset-md-2 products_feedback_top_section-col-2">
                           <div class="w-md-75 px-xl-5 px-md-3 py-md-3 border border-dark ">
                     ...
                     @endphp
                        <div class="row ">
                           <div class="col-md-12">
                           <div class="row my-md-5 product_feedback_item product_feedback_{{$product_id}}" style="display:{{ $product_add_cart_btn_display; }}">
                                 <div class="col-md-3 sticky-div p-md-0 m-md-0 px-md-5 " >
                                    <div class="row">
                     ...
                     @endphp
                        ...
                        <div class="p-3 my-3 text-center proceed-checkout-style m-auto "style="width: 100%;" onclick="stylist_proceed_feedback_page(8,8)">PROCEED TO CHECKOUT 1234</div></a>
