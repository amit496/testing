...
<div class="container-fluid stf_outer_body stylist_step_frontend stf_questeions_screen_wrappr" style="margin: -45px 0 0 0; display: @php if(isset($show_question_answer_screen)) { echo $show_question_answer_screen;}else { echo 'none'; } @endphp">
...
Ready to finish and receive your first reveal? Continue editing";
        ...
        <form action="/storeAnswers" method="post">
         ...
         $sections_screen_arr[2] = array('title' => 'Personal Style', 'title_1' => 'Let us know a bit more about your current style',  'title_2' => '', 'description' => $login_cutomer_obj->name.', tell us a bit about your current personal style. What you like, what you dislike, or specific advice you\'d like on how we can develop you personal image.','img_desktop' => 'images/stylist/questions/section/1_personal_style.webp','womens_screen_image' => 'images/stylist/questions/section/Dappr_animal.jpg' , 'img_mobile' => 'images/stylist/questions/section/1_personal_style.webp','section_id' => 2,'progress_bar_start' => 37,'progress_bar_end' => 59, 'button_text'=>'SAVE & CONTINUE LATER');
        ...
        $sections_screen_arr[3] = array('title' => 'Preferred Styles', 'title_1' => ' ', 'title_2' => '' , 'description' => 'As you know, there are countless styles in each category of clothing. We want to know what you typically choose.',  'img_desktop' => 'images/stylist/questions/section/1_clothing_style_and_fit.webp', 'womens_screen_image' => 'images/stylist/questions/section/women_clothing_style_and_fit_section_image.webp' ,'img_mobile' => 'images/stylist/questions/section/1_clothing_style_and_fit.webp','section_id' => 3,'progress_bar_start' => 59,'progress_bar_end' => 84, 'button_text'=>'SAVE & CONTINUE LATER');
         ...
         if($questions){
            ...
            foreach($questions as $key => $question){
               ...
               if($q_has_logn_text_ans == 'Y'){
                   $answer_html .= '<div class="other_long_text_wrapper" style="display:'.$has_logn_text_ans_display.'"><textarea class="other_long_text stylist_field_text stylist_field_required_long" >'.trim($has_logn_text_ans_text).'</textarea></div> <p class="long_text_error"></p>';
               }
