                ...
                if ($info_records_obj) {
                    ...
                    if($booking_details)
                    {
                        ...
                        if(isset($filter_booking_data) && isset($filter_reveal_data) )
                        {
                            ...
                            {
                                $filter_status_data->customer_id = $get_filter_customer_id;
                                $filter_status_data->customer_name = $get_filter_customer_name;
                                ...
                                $filter_status_data->reveal_send_date = $revel_send_date;
                                $filter_status_data->merchant_id = $get_merchant_id;
                                // dd($filter_status_data);
        ...
        else
        {
            ...
            if($obj)
            {
                ...
                if(isset($call_complete_info))
                {
                    ...
                    $status_filter = new StatusFilterModel();
                    $status_filter->booking_id = $call_booking_id;
