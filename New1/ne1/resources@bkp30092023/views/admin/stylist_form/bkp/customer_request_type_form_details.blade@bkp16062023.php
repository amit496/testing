                            ...
                            <div class="tab-content style-tab-content">
                                <div id="bought_section" class="row tab-pane active">
                                    @php
                                        ...
                                        <div class="articles-two"><h3>'.$buy_product_obj->brand .'</h3><h3>' .$buy_product_obj->name .'</h3><h3>'. $get_prduct_size .'</h3><h3>' .$price .'</h3>
                                        </div>
                                    </div>';
                                            }
                                        }
                                    ...
                                    @php
                                        ...
                                        if (is_array($buy_products) && count($buy_products)) {
                                            foreach ($buy_products as $buy_product_info) {
                                                ...
                                                $buy_html .= '<div class="col-md-2 img-product-1 " style= "'.$cancel_item_hide.'"><div class="rounded"><img src="'.$buy_product_img_src.'" alt="" style="width: 100%;"></div><div class="articles-two"><h3>'.$buy_product_obj->brand .'</h3><h3>' .$buy_product_obj->name .'</h3><h3>'. $get_prduct_size .'</h3><h3>' .$price .'</h3>
                                        </div></div>';
