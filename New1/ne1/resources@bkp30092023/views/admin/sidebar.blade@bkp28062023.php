        ...
        @if (Auth::user()->isMerchant())
            <ul class="sidebar-menu">
                ...
                <li class="treeview {{ Request::is('admin/stylist/booking_dates') ? 'active' : '' }}">
                    <a href="{{ url('admin/stylist/booking_dates') }} "><i
                            class="fa fa-calendar"></i><span>&nbsp;SCHEDULE</span></a>
                </li>

                <li class="treeview {{ Request::is('admin/stylist/availability') ? 'active' : '' }}">
                    <a href="{{ url('admin/stylist/availability') }}"><i class="fa fa-calendar-check"></i><span>&nbsp;MY
                            AVAILABILITY</span></a>
                </li>
                ...
                {{-- tax option  --}}
                {{-- Setting option code start for marchant--}}
            ...
            {{-- Setting option code end for marchant--}}
            </ul>
            ...
            <ul class="sidebar-menu">
                                    ...
                                    <li class="{{ Request::is('admin/catalog/category*') ? 'active' : '' }}">
                                        ...
                                        <ul class="treeview-menu">
                                            @can('index', \App\Models\CategoryGroup::class)
                                                <li
                                                    class="{{ Request::is('admin/catalog/categoryGroup*') ? 'active' : '' }}">
                                            ...
                                            @can('index', \App\Models\CategorySubGroup::class)
                                                <li
                                                    class="{{ Request::is('admin/catalog/categorySubGroup*') ? 'active' : '' }}">
                ...
                @if (Gate::allows('index', \App\Models\Inventory::class) ||
                    ...
                    <li class="treeview {{ Request::is('admin/stock*') ? 'active' : '' }}">
                        ...
                        <ul class="treeview-menu">
                            @if (Gate::allows('index', \App\Models\Inventory::class) || Auth::user()->isSuperAdmin())
                            ...
                            @if (Gate::allows('index', \App\Models\Warehouse::class) || Auth::user()->isSuperAdmin())
                            ...
                            @if (Gate::allows('index', \App\Models\Supplier::class) || Auth::user()->isSuperAdmin())
                ...
                @if (
                    ...
                    <li
                        ...
                        <ul class="treeview-menu">
                            ...
                            @if (Gate::allows('index', \App\Models\Customer::class))
                                <li
                ...
                @if (is_incevio_package_loaded('wallet'))
                    @if (Auth::user()->isAdmin())
                        <li
                            class="treeview {{ Request::is('admin/payouts*') || Request::is('admin/payout*') ? 'active' : '' }}">
                            <a href="javascript:void(0)">
                ...
                @if (Gate::allows('index', \App\Models\Carrier::class) || Gate::allows('index', \App\Models\Packaging::class))
                        ...
                        <ul class="treeview-menu">
                            ...
                            @can('index', \App\Models\Message::class)
                                <li class="{{ Request::is('admin/support/message*') ? 'active' : '' }}">
                                    <a
                                        href="{{ url('admin/support/message/labelOf/' . \App\Models\Message::LABEL_INBOX) }}">
                            ...
                            {{-- @can('index', \App\Models\ContactUs::class) --}}
                                <li class="{{ Request::is('admin/show/contactus') ? 'active' : '' }}">
                                    <a href="{{ url('admin/show/contactus') }}">
                                        <i class="fa fa-angle-double-right"></i> {{ trans('nav.contacts') }}
                                    </a>
                                </li>
                            {{-- @endcan --}}
                        </ul>
                ...
                @if (Auth::user()->isAdmin())
                    <li
                        class="treeview {{ Request::is('admin/promotions*') || Request::is('admin/flashdeal*') || Request::is('admin/promotion*')? 'active' : '' }}">
                        <a href="javascript:void(0)">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="{{ Request::is('admin/promotion/coupon*') ? 'active' : '' }}">
                                <a href="{{ url('admin/promotion/couponUsed') }}">
                                    <i class="fa fa-angle-double-right"></i> {{ trans('nav.usedcoupons') }}
                                </a>
                            </li>
                            @if (Auth::user()->isAdmin() && is_incevio_package_loaded('flashdeal'))
                                <li class="{{ Request::is('admin/flashdeal*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.flashdeal') }}">
                                        <i class="fa fa-angle-double-right"></i>
                                        {{ trans('flashdeal::lang.flashdeal') }}
                                    </a>
                                </li>
                            @endif
                        </ul>
                ...
                @if (Gate::allows('index', \App\Models\Page::class) ||
                                ...
                                @can('index', \Incevio\Package\Eventy\Models\Event::class)
                                    <li class="{{ Request::is('admin/utility/event*') ? 'active' : '' }}">
                                        <a href="{{ url('admin/utility/event') }}">
                                            <i class="fa fa-angle-double-right"></i>
                                            <span>{{ trans('eventy::lang.events') }}</span>
                                        </a>
                                    </li>
                                @endcan
                            @endif
                            ...
                            @if (Auth::user()->isAdmin())
                                ...
                                <li class="{{ Request::is('admin/report/sales*') ? 'active' : '' }}">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li
                                            class="{{ Request::is('admin/report/sales/products*') ? 'active' : '' }}">
                ...
                @if (Auth::user()->isSuperAdmin())
                    ...
                    <li
                        class="treeview {{ Request::is('admin/employer_onboarding_questionnaire') ? 'active' : '' }}">
