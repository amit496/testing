                            ...
                            <div class="dropdown1 dropdown">
                                ...
                                <div class="dropdown-content style_cr_filter_drop_down">
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        started</a>
                                    <a href="javascript:void(0)"
                                        onclick="stfCustomerRequestFilter(this,'reveal_status','call_upcoming','Call Upcoming')">Call Upcoming</a>
                                        <a href="javascript:void(0)"
                            ...
                            @if($list->count() > 0)
                                @foreach($list as $key => $info)
                                    @php
                                        ...
                                        if(isset($stylist_call_complete))
                                        {
                                            $create_date = $stylist_call_complete->created_at;
                                            $create_date_14days = date('d-m-Y', strtotime($stylist_call_complete->created_at . '+14 days'));
                                            // echo $create_date_14days;
                                            $create_date_14days_exp =explode('-',$create_date_14days);
                                            $month_date =  $create_date_14days_exp[0];
                                            $month = $create_date_14days_exp[1];
                                            $task_due_date = $month_date . '/'.$month ;
                                        }
                                        // $appointment_date = date('d-m-Y', strtotime($info->appointment_date . '+14 days'));
