...
$all_steps = ['gtky' => 'Getting to Know you', 'call' => '15 min call', 'reveals' => 'Reveals', 'feedback' =>
'Feedback', 'return_period' => 'Return Period', 'complete' => 'Complete'];
...
<div class="container-fluid stf_outer_body stylist_reveals_section stf_outer_page_load" style="display:none">
    ...
    <div class="row">
        <div class="col-lg-9">
                        ...
                        <div class="Getting-dapp-dash d-flex m-2">
                            ...
                            <div class="dash-butn text-center mt-2">
                                <Span class="stf_anchor_btn"
                                    onclick="stfViewCustomerQuestions({{ $booking_customer_id }})">VIEW RESPONSE<i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="Getting-dapp-dash d-flex m-2">
                            ...
                            <div class="dash-butn text-center mt-2">
                                <Span class="stf_anchor_btn"
                                    onclick="companydetailsview({{ $stylist_user_compnay_id }})">VIEW COMPANY
            ...
            <a data-link="{{ url('admin/stylist/customer_request_response/load_history/' . $booking_id) }} "
            ...
            <div class=" px-4 mt-5">
                ...
                <div class="owl-dappr-slider">
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#feedback_section">Feedback</a>
                        </li> --}}
                    </ul>
                    ...
                    <div class="tab-content style-tab-content">
                        <div id="bought_section" class="row tab-pane active">
                            ...
                            if (isset($item_cancel_item_hide->items) && in_array($buy_inventory_obj->id,
                            $item_cancel_item_hide->items)) {
                            ...
                            !in_array($buy_inventory_obj->id, $approved_refund))
                            {
                            $cancel_item_hide = 'display:block';
                            }
                            elseif ($buy_inventory_obj->id == $key && $value == 'refund') {
                            ...
                            '<div class="col-md-2 img-product-1 " style="' .
                                ...
                                <div class="articles-two">
                                    <h3>'.$buy_product_obj->brand .'</h3>
                                    <h3>' .$buy_product_obj->name .'</h3>
                                    <h3>'. $get_prduct_size .'</h3>
                                    <h3>' .$price .'</h3>
                                    <h3>' .$descriptionnew .'</h3>
                                    <h3>' .$exchange_moreoptioninfo.'</h3>
                                </div>
                            </div>';
                            }
                            }

                            // dump( $buy_product_obj);
                            echo $buy_html;
                            @endphp
                        </div>
                        <div id="declined_section" class="row tab-pane fade">
                            ...
                            in_array($buy_inventory_obj->id,$decline_refund)) {
                            $cancel_item_hide = 'display:none';
                            $return_boolean = false;
                            }
                            elseif ($buy_inventory_obj->id == $key && $value == 'refund') {
                            ...
                            $return_more_option_info =
                            $item_cancel_item_hide?$item_cancel_item_hide->return_more_option:'';
                            ...
                            $buy_html .= '<div class="col-md-2 img-product-1 " style="'.$cancel_item_hide.'">
                                <div class="rounded"><img src="'.$buy_product_img_src.'" alt="" style="max-width: 100%;">
                                </div>
                                <div class="articles-two">
                                    <h3>'.$buy_product_obj->brand .'</h3>
                                    <h3>' .$buy_product_obj->name .'</h3>
                            ...
                            $buy_html .= '<div class="col-md-2 img-product-1"
                                style ="' . $force_hie . '' . $cancel_item_hide . '">
                                <div class="rounded "><img src="' . $buy_product_img_src . '" alt=""
                            ...
                            $buy_html .= '<div class="row mt-4" style="'.$cancel_item_hide.'">
                                <div class="col-md-2 img-product-1">
                                    <div class="rounded "><img src="' . $buy_product_img_src . '" alt=""
                                            style="max-width: 100%;"></div>
                                </div>
                                <div class="col-md-5 img-product-1 " style="'.$cancel_item_hide.'">
                                    <div class="rounded ">
                                        <h4>Cancel</h4>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 articles-two" style="'.$cancel_item_hide.'">
                                    <h3>' . $buy_product_obj->name . '</h3>
                                    <h3>' . $price . '</h3>
                                </div>
                            </div>';
        ...
        <div class="col-lg-3 pr-0 ">
                    ...
                    <div class="card-dappr">
                        <div class="row">
                            <div class=" col-md-6 dappr-img-dash">
                                <img src="{{ url($profile_img_url) }}" alt="">
                            </div>
                            <div class="col-md-12  person-info mb-2 articles">
                                ...
                                <br>
                                <!-- {{ $booking_customer_id }} -->
                                @if (!empty($booking_customer_id) && !empty($customer_details) && $booking_customer_id
                                == $customer_details->id)
                                @if ($customer_details->starrating > 0)
                                @for ($i = 1; $i < 6; $i++) <span class="rating_starcount" starnum="{{ $i }}"
                                    cust_id="{{ $customer_details->id }}"><i
                                        class="far fa-star  @if ($i <= $customer_details->starrating) {{ 'fa-solid' }} @endif "></i></span>
                                    @endfor
                                    @elseif($customer_details->starrating == 0)
                                    @for ($i = 1; $i < 6; $i++) <span class="rating_starcount" starnum="{{ $i }}"
                                        cust_id="{{ $customer_details->id }}"><i class="far fa-star"></i></span>
                                        @endfor
                                        @endif
                        ...
                        <div class="stf_add_tag_btn">
                            <a><i class="fa fa-plus"
                                    onclick="stfAddTagToUser({{ $booking_customer_id }},'this')"></i><input type="text"
                                    placeholder="Add a tag" name="add_tag_to_user"></a>
                        </div>
            ...
            <div class="align-card-dappr-box-s card">
                <div class="card-dappr">
                    ...
                    <div class="stf_add_tag_btn">
                        <a><i class="fa fa-plus"
                                onclick="stfAddNoteToUser({{ $booking_customer_id }},{{ $merchant_id }},{{ $booking_id }},'this')"></i>Add
