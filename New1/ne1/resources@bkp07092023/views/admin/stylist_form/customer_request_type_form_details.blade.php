                                        ...
                                        foreach ($buy_products as $buy_product_info)
                                        {
                                            ...
                                            if (isset($item_cancel_item_hide->items) && in_array($buy_inventory_obj->id,  $item_cancel_item_hide->items))
                                            {
                                                ...
                                                foreach ($exchnage_return_option_decde as $key => $value) {
                                                    if (($buy_inventory_obj->id == $key) && ($value == 'exchange') && in_array($key, $approved_refund) )
                                                    {
                                                        $cancel_item_hide = 'display:block';
                                                    }
                                                    else if (($buy_inventory_obj->id == $key) && ($value == 'exchange') && !in_array($key, $approved_refund) ) {
                                                        $cancel_item_hide = 'display:none';
                                                    }


                                                    if (($buy_inventory_obj->id == $key) && ($value == 'refund') && in_array($key, $approved_refund) )
                                                    {
                                                        $cancel_item_hide = 'display:none';
                                                    }
                                                    else if (($buy_inventory_obj->id == $key) && ($value == 'refund') && !in_array($key, $approved_refund) ) {
                                                        $cancel_item_hide = 'display:block';
                                                    }
                                                ...
                                                //     {
                                                //         print_r($buy_inventory_obj->id == $key);
                                                //         $cancel_item_hide = 'display:block';
                                                //     }
                                                ...
                                                //         $cancel_item_hide = 'display:block';
                                                //     }
                                                //     elseif($buy_inventory_obj->id == $key && $value == 'exchange' &&  !in_array($buy_inventory_obj->id, $declient_refund))
                                                //     {
                                                //         $cancel_item_hide = 'display:block';
                                                //     }
                                    ...
                                    if (is_array($buy_products) && count($buy_products))
                                    {
                                        foreach ($buy_products as $buy_product_info)
                                        {
                                            ...
                                            if (isset($item_cancel_item_hide->items) && in_array($buy_inventory_obj->id, $item_cancel_item_hide->items))
                                            {
                                                ...
                                                foreach ($exchnage_return_option_decde as $key => $value)
                                                {
                                                    // if (($buy_inventory_obj->id == $key) && ($value == 'exchange') && in_array($buy_inventory_obj->id, $decline_refund) )
                                                    // {
                                                    //     $cancel_item_hide = 'display:none';
                                                    //     $return_boolean = false;
                                                    // }
                                                    // else if (($buy_inventory_obj->id == $key) && ($value == 'exchange') && !in_array($buy_inventory_obj->id, $decline_refund) ) {
                                                    //     $cancel_item_hide = 'display:block';
                                                    //     $return_boolean = false;
                                                    // }
                                                    // else {
                                                    ...
                                                    elseif ($buy_inventory_obj->id == $key && ($value == 'exchange') && in_array($buy_inventory_obj->id,$decline_refund))
                                                    {
                                                        $cancel_item_hide = 'display: block';
                                                        $return_boolean = true;
                                                    }
