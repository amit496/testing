                            ...
                            <div class="tab-content style-tab-content">
                                <div id="bought_section" class="row tab-pane active">
                                    @php
                                        ...
                                        <div class="articles-two"><h3>'.$buy_product_obj->brand .'</h3><h3>' .$buy_product_obj->name .'</h3><h3>'. $get_prduct_size .'</h3><h3>' .$price .'</h3><h3>' .$descriptionnew .'</h3><h3>' .$exchange_moreoptioninfo.'</h3>
                                        </div>
                                    </div>';
                                            }
                                        }
                                    ...
                                    @php
                                        ...
                                        if (is_array($buy_products) && count($buy_products)) {
                                            foreach ($buy_products as $buy_product_info) {
                                                ...
                                                $buy_html .= '<div class="col-md-2 img-product-1 " style= "'.$cancel_item_hide.'"><div class="rounded"><img src="'.$buy_product_img_src.'" alt="" style="width: 100%;"></div><div class="articles-two"><h3>'.$buy_product_obj->brand .'</h3><h3>' .$buy_product_obj->name .'</h3><h3>'. $get_prduct_size .'</h3><h3>' .$price .'</h3><h3>' .$description.'</h3><h3>' .$return_more_suboption.'</h3></div></div>';
                        ...
                        <div class="card-dappr">
                                ...
                                <div class="col-md-12  person-info mb-2 articles">
                                    ...
                                    @if (!empty($booking_customer_id) && !empty($customer_details) && $booking_customer_id == $customer_details->id)
                                        @if ($customer_details->starrating > 0)
                                            @for ($i = 1; $i < 6; $i++)
                                                <span class="rating_starcount" starnum="{{ $i }}"
                            ...
                            <div class="stf_add_tag_btn">
                                <a><i class="fa fa-plus"
                                        onclick="stfAddTagToUser({{ $booking_customer_id }},'this')"></i><input
