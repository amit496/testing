...
<header class="main-header customize_header stf_top_header">
  ...
  <nav class="navbar navbar-static-top stf_top_nav" role="navigation">
    ...
    <ul class="nav navbar-nav hidden-xs">
      ...
      {{-- <li>
        <a href="{{ get_shop_url() }}" target="_blank" class="stf_hide_section_class ">
          <i class="fa fa-external-link" style="padding: 0px 5px;"></i> {{ trans('app.store_front') }}
        </a>
      </li> --}}
    </ul>
    
   
    <div class="stf_top_website_name"><img src="{{ url('images/stylist/header_logo.png') }}" alt="DAPPER"></div>
    <!-- Navbar Right Menu -->
      ...
      <ul class="nav navbar-nav">
        ...
        {{-- <li class="dropdown messages-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="footer"><a href="{{ url('admin/support/message/labelOf/' . \App\Models\Message::LABEL_INBOX) }}">{{ trans('app.go_to_msg_inbox') }}</a></li>
          </ul>
        </li><!-- /.messages-menu --> --}}
