...
class Order extends BaseModel
{
    ...
    { 
        ...
        foreach ($this->inventories as $item) {
            ...
            {
                // echo $item_desc_info;
                if(!empty($item_desc[0]) || !empty($item_desc[1]) || !empty($item_desc[4]))
                {
        ...
        //                     if(($item->id == $refund_approved_items) && ($cancel_request_status == 6))
        //                     {
        //                         $newval = $this->total - (int) $item->pivot->unit_price;
        //                     }
        //                     else
        //                     {   
        //                         $get_total_amount = $this->total;
        //                     }
        //                 }
        //             }
        //         }
        ...
        // else
        // {
        //     $invoice->addSummary(trans('invoice.total'), $get_total_amount);
        ...
        //         $cancel_exchange_retunr_option = json_decode($this->cancellation->exchnage_return_option, true);
        //         // echo "<pre>";
        //         // print_r($cancel_exchange_retunr_option);
                
        //         // echo "<pre>";
        //         // print_r($cancel_retunr_approveditems);
                
        //         // echo $cancel_request_status;
        //         foreach ($cancel_exchange_retunr_option as $key => $values)
        //         {
        //             // echo ($key==$item->id)?$values.$key:'';
        //             // echo ($key==$item->id)?$item->pivot->unit_price:'';
        //             if(($item->id == $key) && ($values == 'refund')){
        //                 $cancel_request_status = $this->cancellation->status;
        //                 $cancel_retunr_approveditems = explode(',',$this->cancellation->approve_items);
        //                 $return_keys = $key;
        ...
        //                     if(($item->id == $refund_approved_items) && ($cancel_request_status == 6))
        //                     {
        //                         $newval = $order_total - (int) $item->pivot->unit_price;
        //                     }
        //                     else
        //                     {   
        //                         $get_total_amount = $order_total;
        //                     }
        //                 }
        //             }
        //         }
        ...
        // if(($newval != 0)  && ($newval != ''))
        // {
        //     $invoice->addSummary(trans('invoice.total'), $newval, true);
        // }
        // else
        // {
        //     $invoice->addSummary(trans('invoice.total'), $get_total_amount, true);
        // }
