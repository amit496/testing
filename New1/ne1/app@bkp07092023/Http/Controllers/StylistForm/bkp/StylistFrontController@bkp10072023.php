            ...
            elseif(isset($stylist_call_complete) || (isset($reveal_info_draft_has) && $reveal_info_draft_has->status == 'draft'))
            {
                ...
                if(isset($booking_obj))
                {
                    ...
                    {   
                        ...
                        else if(isset($order_data_info)  && ($booking_obj->status =='return_initiated') && ($reveal_info_has->status =='return_initiated') && (($order_data_info->order_status_id == 6) || ($order_data_info->order_status_id != 6)) && isset($cancel_data) && ($cancel_data->status == 1) && (strtotime($cancel_data->created_at) <= strtotime($update_14_days)))
                        {
