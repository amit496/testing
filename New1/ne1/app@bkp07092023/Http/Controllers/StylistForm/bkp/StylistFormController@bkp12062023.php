                    ...
                    if ($feedback_info_obj){
                        foreach ($feedback_info_obj as $feedback_info_info) {
                            ...
                            if ($product_obj) {
                                ...
                                $inventory_obj = Inventory::where('product_id', $product_obj->id)->latest()->first();
                                if ($inventory_obj) {
                                ...
                                <div class=" img-product-1 "><div class="rounded "><img src="' . $img_src . '" alt=""  style="width: 100%;"></div><div class="articles-two"><h3>' . $brand_name . '</h3><h3>' .$product_obj->name  . '</h3><h3>' . $price . '</h3><h3>' . $decline_options_data. '</h3></div><div>' . $other_msg . '</div></div>
                                </div></div>';
