        ...
        <div class="col-md-8">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8 text-right">
              {!! Form::submit(trans('theme.button.update'), ['class' => 'btn btn-primary flat user_account_button', 'style'=>'background:#6DBCD4']) !!}
            </div>
          </div>
          {!! Form::close() !!}
        </div><!-- /.col-md-8 -->
        ...
        <div class="col-md-4">
          <div class="user-avatar-section text-center">
            <div class="form-group">
              ...
              {{-- {!! Form::label('avatar', trans('theme.profile')) !!} --}}
      ...
      <div class="row">
        <div class="col-md-8 col-sm-offset-1">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8 text-right">
              {!! Form::submit(trans('theme.button.update'), ['class' => 'btn btn-primary flat', 'style' => 'background:#6DBCD4']) !!}
            </div>
          </div>
          {!! Form::close() !!}
        </div><!-- /col-md-8 -->
