        ...
        <table class="table" id="buyer-payment-detail-table">
          ...
          <tbody>
            ...
            <tr class="buyer-payment-info-body">
              ...
              <td colspan="2">${{ number_format($contribution_amount,  2 , '.', '') }}</td>
            ...
            <tr class="buyer-payment-info-head" style=" background: #6DBCD4;">
              <td colspan="2">@lang('theme.total_amount')</td>
            ...
            <tr class="order-info-head">
              ...
              <td width="20%" class="order-amount">
                <h5 class="my-1">
                  ...
                  <span  style="color:#6DBCD4;">@lang('theme.order_amount'): </span>{{ '$'.number_format($contribution_amount, 2 ,'.', '') }}
                </h5>
              </td>
            </tr> <!-- /.order-info-head -->
