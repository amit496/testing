      ...
      <div class="col-md-4 bg-light">
        ...
        <ul class="shopping-cart-summary ">
          ...
          <li id="discount-section-li{{ $cart->id }}" style="display: <?php if($cart->discount > 0){echo'none' ;}else{echo 'block' ;}?>">
            <span>{{ trans('theme.employee_contribution') }}
              ...
              <em id="summary-discount-name{{ $cart->id }}" class="small text-muted">${{$cart->coupon ? number_format($cart->discount, 0, '.', '') : number_format(0, 2, '.', '') }} off by company (${{$cart->coupon ? number_format($cart->discount, 0, '.', '') : number_format(0, 2, '.', '')}})</em>
            </span>
