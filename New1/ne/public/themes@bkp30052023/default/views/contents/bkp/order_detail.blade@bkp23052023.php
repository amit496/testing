        ...
        <table class="table" id="buyer-payment-detail-table">
          ...
          <tbody>
            ...
            <tr class="buyer-payment-info-body">
              ...
              <td colspan="2">${{ number_format($order->grand_total,  2 , '.', '') }}</td>
            ...
            <tr class="order-info-head">
              ...
              <td width="20%" class="order-amount">
                <h5 class="my-1">
                  ...
                  <span  style="color:#6DBCD4;">@lang('theme.order_amount'): </span>{{ '$'.number_format($order->grand_total, 2 ,'.', '') }}
                </h5>
              </td>
            </tr> <!-- /.order-info-head -->
