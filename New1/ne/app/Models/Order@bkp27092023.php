    ...
    public function invoice($des = 'D')
    {
        ...
        foreach ($this->inventories as $item) {
            ...
            foreach ($item_desc as $key => $item_desc_info)
            {
                ...
                //     $item_description = '';
                // }
                if ((isset($item_desc[0]) && ($item_desc[0] !== '')) && (isset($item_desc[1]) && ($item_desc[1] !== '')) && (isset($item_desc[4]) && $item_desc[4] !== ''))
                {
                    $item_description = $item_desc[0] . ',' . $item_desc[1] . ',' . $item_desc[4];
                }
                else if((isset($item_desc[0]) && ($item_desc[0] !== '')) && (isset($item_desc[1]) && ($item_desc[1] !== '')))
                {
                    $item_description = $item_desc[0] . ',' . $item_desc[1];
                }
                else if ((isset($item_desc[0]) && ($item_desc[0] !== ''))  )
                {
