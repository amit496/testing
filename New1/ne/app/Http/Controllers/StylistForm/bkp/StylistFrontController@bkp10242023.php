...
class StylistFrontController extends Controller
{
    ...
    {
        $add_on_click_event = '';
        $customer_give_question_obj_get_all_ans ='';
        ...
        $customer_give_question_obj_get_all_ans = StylistCustomerQuestionsAnswer::where('customer_id', $customer_id)->orderby('id', 'desc')->pluck('answer_ids')->first();
