      ...
      <div class="modal-body nopadding">
        ...
        <div class="box-widget widget-shop">
          ...
          <div class="widget-shop-image">
            <img src="<?php echo e(get_storage_file_url(optional($shop->logo)->path, 'small'), false); ?>" alt="<?php echo e(trans('theme.logo'), false); ?>">
          </div>
            ...
            <div class="col-sm-4 border-right">
              <div class="description-block">
                ...
                <span class="description-text small">
                  <?php echo $__env->make('theme::layouts.ratings', ['ratings' => $shop->feedbacks->avg('rating'), 'count' => $shop->feedbacks->count()], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </span>
              </div>
            </div>
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="merchant_tab">
              <div class="row">
                <div class="col-sm-3">
                  <img src="<?php echo e(get_avatar_src($shop->owner, 'logo_lg'), false); ?>" class="img-rounded">
                </div>
                <div class="col-sm-9">
                  <?php echo $shop->owner->name; ?><br />
                  <?php echo $shop->address->toShortString(); ?><br />
                  <?php echo $shop->config->support_phone; ?><br />
                  <?php echo $shop->config->support_email; ?><br />
                </div>
              </div> <!-- /.row -->
            </div> <!-- /.tab-pane -->
            ...
            <div class="tab-pane" id="shop_reviews_tab">
              <?php $__empty_1 = true; $__currentLoopData = $shop->latestFeedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <p>
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/default/views/modals/shopReviews.blade.php ENDPATH**/ ?>