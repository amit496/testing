          ...
          <div class="tab-pane active" id="listing_tab">
            <table class="table">
              ...
              <tr>
                ...
                <td style="width: 75%;"> <?php echo e(get_formated_currency($inventory->sale_price, 2), false); ?> </td>
              </tr>
              ...
              <?php if($inventory->puchase_price): ?>
                <tr>
                  ...
                  <td style="width: 75%;"> <?php echo e(get_formated_currency($inventory->puchase_price, 2), false); ?> </td>
                </tr>
              <?php endif; ?>
            ...
            <table class="table">
              ...
              <?php if($inventory->product->min_price && $inventory->product->min_price > 0): ?>
                <tr>
                  ...
                  <td style="width: 75%;"><?php echo e(get_formated_currency($inventory->product->min_price, 2), false); ?></td>
                </tr>
              <?php endif; ?>
              <?php if($inventory->product->max_price && $inventory->product->max_price > 0): ?>
                <tr>
                  ...
                  <td style="width: 75%;"><?php echo e(get_formated_currency($inventory->product->max_price, 2), false); ?></td>
                </tr>
              <?php endif; ?>
            ...
            <table class="table">
              <?php if($inventory->offer_price && $inventory->offer_price > 0): ?>
                <tr>
                  ...
                  <td style="width: 75%;"><?php echo e(get_formated_currency($inventory->offer_price, 2), false); ?></td>
                </tr>
              <?php else: ?>
                <tr>
...
<?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/inventory/_show.blade.php ENDPATH**/ ?>