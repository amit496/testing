      ...
      <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
          <a href="<?php echo e($slider['link'], false); ?>">
            <img src="<?php echo e(get_storage_file_url($slider['feature_image']['path'] ?? null, 'full'), false); ?>" alt="<?php echo e($slider['title'] ?? 'Slider Image ' . $loop->count, false); ?>">
          </a>
    ...
    <ul class="ei-slider-thumbs">
      ...
      <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
          ...
          <img src="<?php echo e(get_storage_file_url($slider['images'][0]['path'] ?? ($slider['feature_image']['path'] ?? null),'slider_thumb'), false); ?>" alt="thumbnail <?php echo e($loop->count, false); ?>" />
        </li>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
  </div>
</section>
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/default/views/sections/slider.blade.php ENDPATH**/ ?>