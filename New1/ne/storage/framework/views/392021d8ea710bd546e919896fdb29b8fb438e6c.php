      ...
      <table class="table table-hover table-no-sort">
        <thead>
          <tr>
            ...
            <th><?php echo e(trans('app.refund_requested'), false); ?></th>
        ...
        <tbody>
          <?php $__currentLoopData = $disputes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dispute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                <?php echo e(get_formated_currency($dispute->refund_amount, 2), false); ?>
              ...
              <td class="row-options">
                <a href="<?php echo e(route('admin.support.dispute.show', $dispute->id), false); ?>"><i data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('app.detail'), false); ?>" class="fa fa-expand"></i></a>&nbsp;
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/dispute/index.blade.php ENDPATH**/ ?>