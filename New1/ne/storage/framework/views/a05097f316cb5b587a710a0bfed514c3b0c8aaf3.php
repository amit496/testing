...
<div class="container-fluid stf_outer_body stylist_step_frontend stf_questeions_screen_wrappr" style="margin: -45px 0 0 0; display: <?php if(isset($show_question_answer_screen)) { echo $show_question_answer_screen;}else { echo 'none'; } ?>">
   <input type="hidden" name="appointment_response_id" value="">
   <div class="row">
      <div class="container ">

         <section class="stf_start_screen p-2" style="display: <?php if(isset($show_quesiton_answer_fisrt_screen) ) { echo $show_quesiton_answer_fisrt_screen;}else { echo 'none'; } ?>">

            <?php

            $start_screen_subheading_text_2 = "<p>This questionnaire is a once-off to ensure a comprehensive and personalised service with your stylist. It will take roughly 10 min to complete.</p>
                                    <p> Towards the end of the questionnaire, you’ll get to arrange a time with your stylist.</p>";
            ...
            if($customer_give_question_obj){
                $start_screen_btn_text = "CONTINUE EDITING";
                  // $start_screen_subheading_text = "Continue editing your Getting to <br> know your questionnaire";
                  $start_screen_subheading_text = "You haven't quite completed your Getting to Know You questionnaire. 
Ready to finish and receive your first reveal? Continue editing";
            ...
            <div class="row" >
               <div class="col-lg-5 card mb-5 border-0 m-auto">
                  <div class="p-md-4">
                     <div class="mb-4 dappr-text-h pt-0">
                        <h3><u>Welcome <?php echo $login_cutomer_obj->name; ?></u></h3>
                     </div>
                        ...
                        <div class="style-field-checkbox-outer_rename col-md-12 my-2 p-0">
                           <div class=" merchant_item product_box_outer">
                              <div class=" product_box  ">
                                 <div class=" my-3">
                                    <p><?php echo $start_screen_subheading_text; ?></p>
                                 ...
                                 <div class=" mb-3 custom_product_img_box pro_img_has">
                                    ...
                                    <div class="">
                                        <img src="<?php echo e(url('images/stylist/15.png?').rand(10,100), false); ?>" alt="" class="getting_to_know_image" style="width: 100%;">
                                    </div>

                                 </div>
                                 <div class=" my-3">
                                    <?php echo $start_screen_subheading_text_2; ?>

                                 </div>
                              </div>
                              <div class="pt-2 justify-content-between botom-style-previous-rename">
                                 <a onclick="stylist_question_start();return false;" class="btn stf_save_btn d-block  editing_btn"><?php echo e($start_screen_btn_text, false); ?></a>
                              </div>
                           </div>
                        </div>
               ...
               <!-- <div class="row my-md-5 align-items-center">
                  ...
                  <div class="col-md-6 gett-text-img p-0 order-1 order-md-2">
                     <img src="<?php echo e(url('images/stylist/15.png'), false); ?>" alt=""  style="width: 100%;">
                  </div>
               </div>
            </div> -->
         ...
         <section class="stylist_qeustions_list " style="display: <?php if(isset($show_quesiton_answer_edit_screen)) { echo $show_quesiton_answer_edit_screen;}else { echo 'none'; } ?>";">
         ...
         <ul class="position-relative d-md-flex_rename align-items-center female-style-menu text-nowrap overflow-auto py-3 mt-3  "  style_rename="display: none;">
            ...
            <li class="pr-4 stylist_step_progress stylist_step_progress_1 stylist_step_progress_active stylist_step_progress_active_tab  <?php if(in_array(0, $already_take_questions_section_heading_arr)){ echo ' stylist_step_progress_active_already '; } ?> " q_section="0" progress_bar_width = '0' >
            ...
            <li class="pr-4 stylist_step_progress stylist_step_progress_2  <?php if(in_array(1, $already_take_questions_section_heading_arr)){ echo ' stylist_step_progress_active_already '; } ?> " q_section="1" progress_bar_width = '17' >
               <div class="menu-link stf_anchor_btn">
               <i class="fal fa-circle pr-2"></i>
            ...
            <li class="pr-4 stylist_step_progress stylist_step_progress_3  <?php if(in_array(2, $already_take_questions_section_heading_arr)){ echo ' stylist_step_progress_active_already '; } ?> " q_section="2" progress_bar_width = '37' >
              <div class="menu-link stf_anchor_btn">
              <i class="fal fa-circle pr-2"></i>
            ...
            <li class="pr-4 stylist_step_progress stylist_step_progress_4  <?php if(in_array(3, $already_take_questions_section_heading_arr)){ echo ' stylist_step_progress_active_already '; } ?> "  q_section="3" progress_bar_width = '58' >
               <div class="menu-link stf_anchor_btn" >
               <i class="fal fa-circle pr-2"></i>
            ...
            <li class="pr-4 stylist_step_progress stylist_step_progress_6  <?php if(in_array(4, $already_take_questions_section_heading_arr)){ echo ' stylist_step_progress_active_already '; } ?> " q_section="4" progress_bar_width = '83' >
               <div class="menu-link stf_anchor_btn">
               <i class="fal fa-circle pr-2"></i>
            ...
            <li class="pr-4 stylist_step_progress stylist_step_progress_7  <?php if(in_array(5, $already_take_questions_section_heading_arr) || in_array(6, $already_take_questions_section_heading_arr)){ echo ' stylist_step_progress_active_already '; } ?> " q_section="5"  progress_bar_width = '100'>
               <div class="menu-link stf_anchor_btn">
               <i class="fal fa-circle pr-2"></i>
               <span>BUDGET</span>
               </div>
        ...
        <form action="/storeAnswers" method="post">
         ...
         $sections_screen_arr[2] = array('title' => 'Personal Style', 'title_1' => 'Let us know a bit more about your current style',  'title_2' => $login_cutomer_obj->name.', tell us a bit about your current personal style. What you\'re drawn too, what you\'d potentially like to change or get advice on and how we can help your personal brand and image develop.', 'description' => '','img_desktop' => 'images/stylist/questions/section/1_personal_style.webp','womens_screen_image' => 'images/stylist/questions/section/Dappr_animal.jpg' , 'img_mobile' => 'images/stylist/questions/section/1_personal_style.webp','section_id' => 2,'progress_bar_start' => 37,'progress_bar_end' => 59, 'button_text'=>'SAVE & CONTINUE LATER');
            ...
            foreach($questions as $key => $question){
               ...
               if(!in_array($section_heading_id, $section_heading_ids)){
                  ...
                  if(isset($sections_screen_arr[$section_heading_id])){
                              ...
                              <div class="col-md-6 order-md-1 order-2 p-0">
                                 <div class="d-flex align-items-center h-100">
                                    <div class="col-lg-6 m-auto px-4">
                                       ...
                                       <div class="style-field-checkbox-outer_rename my-2 p-0">
                                          <div class=" merchant_item product_box_outer">
                                             <div class=" product_box">
                                                <div class=" my-3">
                                                ...
                                                <div class=" my-3 first_question_screen">
                     ...
                     <div class=" py-4 px-4 botom-style-previous">
                        ...
                        if($key == 0){
                      $html  .= '</a><a href_rename="javascript:void(0)" onclick="stylist_step_show(this,\'\');return false;" class="stf_anchor_btn  question_save_btn">Next</a></div>
               ...
               if($question->name){
                ...
                if($question->description != ''){
                    $html  .= '<p class="m-0 q_description question_description ">'.$question->description.'</p>';
                }
               ...
               if($question->type == 'text'){
                ...
                $html  .= '<div class="stylist_field_outer">';
                  $answer_html .= '<textarea placeholder="Type your answer here" style="width: 100%;"  class="stylist_field stylist_field_text custom-stylist_field '.$question_required_class.'  answer_type_textarea" name="question['.$question_id.']"  answer_id="'.$answer_id.'"
                   question_id="'.$question_id.'" />'.$alredy_naswer_text.'</textarea>';
                  ...
                  $answer_html .= '<input placeholder="Type your answer here" type="file" class="stylist_field stylist_field_text '.$question_required_class.'" name="question['.$question_id.']" answer_id="'.$answer_id.'"
                   question_id="'.$question_id.'" / value="" onchange="stfUploadfileShow(this)" >';
                    ...
                    $answer_html .= '<input type="hidden" name="file_image" value="'.$answer_img.'">';
                  ...
                  if($question->hide_answer_label == 'Y'){
                   ...
                   $random_ans_list = [];
                     if(($question->fix_rand_id == 'fix_rand_id_63') || ($question->fix_rand_id == 'fix_rand_id_55')){
                         foreach($question->answers as $answer_key => $answer){
                  ...
                  foreach($question->answers as $answer_key => $answer){
                     ...
                     if($question->multiple_select == 'Y'){
                        ...
                        $ans_box_class = ' product_box_multi_select ';
                     }
...
<div class="stf_stylist_booking_screen" style="display:<?php if(isset($show_booknig_screen)) {echo $show_booknig_screen;}else { echo 'none'; } ?> ">
   <?php
      $class_list = ' ';
      $class_form = ' ';
      if($errors->any()){
   ...
   <div class="container">
     ...
     <div class="row p-md-4">
         ...
         <div class="container pb-3  dappr-text-h m-auto pt-4">
         ...
         foreach($merchants_obj as $merchant_obj){
          ...
          $html  .= '<div class="style-field-checkbox-outer my-2 w-50 m-auto">';
         ...
         <div class="w-50 m-auto customer_booking_date_time_wrapper" style="display: none;">
...
<?php echo $__env->make('theme::layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/stylist_form/customer_question_answer.blade.php ENDPATH**/ ?>