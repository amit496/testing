  ...
  <div class="col-md-8">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          <?php echo e(isset($inventory) ? trans('app.update_inventory') : trans('app.add_inventory'), false); ?>
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-md-<?php echo e(config('system_settings.show_item_conditions') ? 6 : 9, false); ?> nopadding-right">
            <div class="form-group">
            ...
            <div class="col-md-6 nopadding-right">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <?php echo Form::number('sale_price', isset($inventory) ? $inventory->sale_price : null, ['class' => 'form-control', 'min' => $product->min_price, 'max' => $product->max_price ?? PHP_INT_MAX, 'step' => 'any', 'placeholder' => trans('app.placeholder.sale_price'), 'required']); ?>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <?php if(is_incevio_package_loaded('pharmacy')): ?>
          <?php echo $__env->make('pharmacy::inventory_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        ...
        <?php if($requires_shipping): ?>
          <fieldset>
            ...
            <div class="form-group">
              ...
              <?php echo Form::select('warehouse_id', $warehouses, isset($inventory) ? null : config('shop_settings.default_warehouse_id'), ['class' => 'form-control select2', 'placeholder' => trans('app.placeholder.select'), 'required']); ?>
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" id="<?php echo e($attribute->name, false); ?>" name="variants[<?php echo e($attribute->id, false); ?>]" placeholder=<?php echo e(trans('app.placeholder.select'), false); ?>>
                  ...
                  <?php $__currentLoopData = $attribute->attributeValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($attributeValue->id, false); ?>" <?php echo e(isset($inventory) &&count($inventory->attributes) &&in_array($attributeValue->id, $inventory->attributeValues->pluck('id')->toArray())? 'selected': '', false); ?>>
...
<?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/inventory/_form.blade.php ENDPATH**/ ?>