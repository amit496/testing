          ...
          <div class="box-header with-border">
            ...
            <div class="box-tools col-lg-4 pull-right nopadding-right">
              <div class="has-feedback">
                <?php echo Form::open(['route' => 'search.message', 'method' => 'get', 'id' => 'form', 'data-toggle' => 'validator']); ?>
            ...
            <div class="mailbox-controls">
              ...
              <div class="btn-group ">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="javascript:void(0)" data-link="<?php echo e(route('admin.support.message.massUpdate', [App\Models\Message::STATUS_NEW, 'status']), false); ?>" class="massAction" data-doafter="reload">
                      <i class="fa fa-envelope-o"></i> <?php echo e(trans('app.new'), false); ?></a></li>
                  <li><a href="javascript:void(0)" data-link="<?php echo e(route('admin.support.message.massUpdate', [App\Models\Message::STATUS_READ, 'status']), false); ?>" class="massAction" data-doafter="reload"><i class="fa fa-envelope-open"></i> <?php echo e(trans('app.read'), false); ?></a></li>
                  <li><a href="javascript:void(0)" data-link="<?php echo e(route('admin.support.message.massUpdate', [App\Models\Message::STATUS_UNREAD, 'status']), false); ?>" class="massAction" data-doafter="reload"><i class="fa fa-envelope"></i> <?php echo e(trans('app.unread'), false); ?></a></li>
                  <li class="divider"></li>

                  <?php if($requestLabel <= \App\Models\Message::LABEL_DRAFT): ?>
                    <li><a href="javascript:void(0)" data-link="<?php echo e(route('admin.support.message.massUpdate', [App\Models\Message::LABEL_SPAM, 'label']), false); ?>" class="massAction" data-doafter="remove"><i class="fa fa-filter"></i> <?php echo e(trans('app.spam'), false); ?></a></li>

                    <li><a href="javascript:void(0)" data-link="<?php echo e(route('admin.support.message.massUpdate', [App\Models\Message::LABEL_TRASH, 'label']), false); ?>" class="massAction" data-doafter="remove"><i class="fa fa-trash"></i> <?php echo e(trans('app.trash'), false); ?></a></li>
                  <?php else: ?>
                    <li><a href="javascript:void(0)" data-link="<?php echo e(route('admin.support.message.massUpdate', [App\Models\Message::LABEL_INBOX, 'label']), false); ?>" class="massAction" data-doafter="remove"><i class="fa fa-inbox"></i> <?php echo e(trans('app.move_to_inbox'), false); ?></a></li>
                  <?php endif; ?>
                    ...
                    <tr id="item_<?php echo e($message->id, false); ?>">
                      ...
                      <td class="mailbox-subject">
                        <a href="<?php echo e(route('admin.support.message.show', $message), false); ?>" style="<?php echo e($message->isUnread() ? 'color: #222;' : '', false); ?>">
                          <strong><?php echo highlightWords($message->subject, $search_q); ?> </strong> - <?php echo highlightWords(Str::limit(strip_tags($message->message), 180 - strlen($message->subject)), $search_q); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/admin/message/index.blade.php ENDPATH**/ ?>