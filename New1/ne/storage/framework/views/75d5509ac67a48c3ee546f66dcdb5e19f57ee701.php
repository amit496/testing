  ...
  <div class="box login-box-body">
    ...
    <div class="box-body">
      ...
      <div class="form-group has-feedback">
        <?php echo Form::email('email', null, ['class' => 'form-control input-lg', 'placeholder' => trans('app.form.email_address'), 'required']); ?>
    ...
    <a class="btn btn-link" href="<?php echo e(route('vendor.register'), false); ?>" class="text-center"><?php echo e(trans('app.form.register_as_merchant'), false); ?></a>
  </div>
...
<?php echo $__env->make('auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/auth/login.blade.php ENDPATH**/ ?>