<?php $__env->startSection('content'); ?>
  <?php if(config('app.demo') !== true || config('app.debug') == true): ?>
    <div class="box">
      <?php
              ...
              <?php $__currentLoopData = $storeFrontThemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="theme col-sm-6 col-md-4 nopadding-left">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      <p class="lead">
                        <?php echo e($theme['name'], false); ?>

                        <small class="pull-right">v-<?php echo e($theme['version'], false); ?></small>
                      </p>
                  ...
                  <div class="thumbnail <?php echo e($theme['slug'] == active_selling_theme() ? 'active' : '', false); ?>">
                    ...
                    <div class="caption">
                      ...
                      <?php if($theme['slug'] == active_selling_theme()): ?>
                        <p>
                          <button class="btn btn-success" disabled><?php echo e(trans('app.current_theme'), false); ?></button>
                        </p>
                      <?php else: ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/theme/index.blade.php ENDPATH**/ ?>