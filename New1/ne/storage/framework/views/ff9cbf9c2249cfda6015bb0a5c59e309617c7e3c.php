<?php if(isset($recently_viewed_items) && count($recently_viewed_items)): ?>
  <section>
          ...
          <div class="best-under__header">
            <div class="sell-header sell-header--bold">
              <div class="sell-header__title">
                <h2><?php echo app('translator')->get('theme.recently_viewed'); ?></h2>
              </div>
...
<?php endif; ?>
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/public/themes/default/views/sections/recent_views.blade.php ENDPATH**/ ?>