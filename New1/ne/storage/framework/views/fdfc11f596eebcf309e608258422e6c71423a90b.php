                            ...
                            <td colspan="6">
                                <div class="input-group full-width" style="z-index:-1">
                                    ...
                                    <input name="coupon" value=""
                                        id="coupon<?php echo e($cart->id, false); ?>" class="form-control flat" type="text"
                                        placeholder="<?php echo app('translator')->get('theme.placeholder.have_coupon_from_seller'); ?>">

                                    <span class="input-group-btn">
                                        <button class="btn btn-default flat apply_seller_coupon" type="button"
                                            data-cart="<?php echo e($cart->id, false); ?>"><?php echo app('translator')->get('theme.button.apply'); ?></button>
                                    </span>
                                </div><!-- /input-group -->
                            </td>
                        </tr>
