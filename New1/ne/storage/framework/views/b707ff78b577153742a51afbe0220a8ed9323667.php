...
<?php if(config('seo.enabled')): ?>
    ...
    <?php if(isset($item)): ?>
        ...
        <meta name="product:price:amount" content="<?php echo get_formated_currency($item->current_sale_price(), config('system_settings.decimals', 2)); ?>">
    ...
    <?php if(isset($item)): ?>
        ...
        <meta name="twitter:data1" content="<?php echo get_formated_currency($item->current_sale_price(), config('system_settings.decimals', 2)); ?>">
        ...
        <script type="application/ld+json">
            {
                ...
                "offers": {
                    ...
                    "price": "<?php echo get_formated_decimal($item->current_sale_price(), true, config('system_settings.decimals', 2)); ?>"
                },
...
<?php /**PATH /home/dappr/public_html/portal.dappr.com.au/resources/views/meta.blade.php ENDPATH**/ ?>