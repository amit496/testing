  ...
  <div class="box">
    ...
    <div class="box-body">
      <table class="table table-hover table-2nd-no-sort">
        <thead>
          <tr>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDelete', \App\Models\Slider::class)): ?>
        ...
        <tbody id="massSelectArea">
          <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <?php endif; ?>
              <td>
                <img src="<?php echo e(get_storage_file_url(optional($slider->mobileImage)->path, 'cover_thumb'), false); ?>" class="" height="50%" alt="<?php echo e(trans('app.image'), false); ?>">
              </td>
              <td>
              ...
              <td>
                <img src="<?php echo e(get_storage_file_url(optional($slider->featureImage)->path, 'cover_thumb'), false); ?>" class="thumbnail" alt="<?php echo e(trans('app.slider_image'), false); ?>">
              </td>
              <td>
                ...
                <br />
                <?php echo e(trans('app.alternative_color') . ': ', false); ?><strong><?php echo $slider->alt_color; ?></strong>
                <br />
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dappr/public_html/test.dappr.com.au/resources/views/admin/slider/index.blade.php ENDPATH**/ ?>